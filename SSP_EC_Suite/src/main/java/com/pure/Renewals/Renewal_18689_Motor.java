...
public class Renewal_18689_Motor extends BaseTest {
	...
	@Test(description = "Verify that user can navigate to pay by card screen only if Annually button is selected in  payment method screen for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21985(String browser) throws Exception {

		String tcId = "TC_21985";
	...
	@Test(description = "Verify that Payment Amount which is displayed in pay by card screen is same as actual amount paid by the client ie (Insurer Premium + Addons + Fees) for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21986(String browser) throws Exception {

		String tcId = "TC_21986";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
		...
		try {
			...
			Log.softAssertThat(RenewalPaymentCard.getInsurerPremiumAmount(testData.totalpremiumAmount),
					"Total Premium Amuont for policy is shown in the Renew Pay by Card page", "Total Premium Amuont for policy is not shown in the Renew Pay by Card page", driver,
					extentedReport, true);
	...
	@Test(description = "Verify that List of Existing Cards details which is displayed in BO is same that is displayed in pay by card screen(ignore any cards with a expiry date in the past) for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21987(String browser) throws Exception {

		String tcId = "TC_21987";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	@Test(description = "Verify that If the last used Card by this customer is in the list provided in BO, and then pre selected by default in pay by card screen for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21988(String browser) throws Exception {

		String tcId = "TC_21988";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	@Test(description = "Verify that clicking on Cancel button in the Pay by card screen will be navigated back to the Policy Details screen by hitting the Close button for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21989(String browser) throws Exception {

		String tcId = "TC_21989";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	@Test(description = "Verify that ‘Buy’ button is disabled until a card is selected in pay by card screen for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21990(String browser) throws Exception {

		String tcId = "TC_21990";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
		...
		try {
			...
			RenewalPaymentCard.defaultCheckBoxForCard(testData.existingCardNumber, extentedReport, true);
			...
			RenewalPaymentCard.selectCheckBoxForCard(testData.existingCardNumber, extentedReport, true);
	...
	//@Test(description = "Verify if user could able to make successful payment by clicking on the ‘Buy’ button in pay by card screen for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21991(String browser) throws Exception {

		String tcId = "TC_21991";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	//@Test(description = "Verify that upon a Unsuccessful Payment User would be informed with error message and the policy will remain in Invited status until the payment gets confirmed and no transaction will be raised for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21992(String browser) throws Exception {

		String tcId = "TC_21992";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	//@Test(description = "Verify that any new Credit card processed in buy Renewals should be saved with the client in pure for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21993(String browser) throws Exception {

		String tcId = "TC_21993";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	@Test(description = "Verify that all the available credit cards on the client in pure where the expiry date has not been passed should be available for Renewal credit card payment for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21994(String browser) throws Exception {

		String tcId = "TC_21994";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	//@Test(description = "Verify that User must be able to pay by a new credit card for an additional Renewal Premium when the new business policy premium was paid by premium finance for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21995(String browser) throws Exception {

		String tcId = "TC_21995";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	//@Test(description = "Verify that User must be able to pay by an existing credit card for Renewal premium when the new business policy premium was paid by credit card for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21996(String browser) throws Exception {

		String tcId = "TC_21996";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	//@Test(description = "Verify that User must be able to pay by a new credit card for Renewal premium when the new business policy premium was paid by credit card for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21997(String browser) throws Exception {

		String tcId = "TC_21997";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	@Test(description = "Verify that all the previously used and available credit cards with client in pure should be available to consumer when they pay Renewal premium by credit card for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21998(String browser) throws Exception {

		String tcId = "TC_21998";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	//@Test(description = "Verify that if consumer pay Renewal premium by new credit card then the new credit card details should be saved with client in pure for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21999(String browser) throws Exception {

		String tcId = "TC_21999";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	@Test(description = "Verify that removed card on client in pure should not be available for credit card payment for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_22000(String browser) throws Exception {

		String tcId = "TC_22000";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
		...
		try {
			...
			Log.softAssertThat(!RenewalPaymentCard.verifyExistingCardNumber(testData.existingCardNumber, extentedReport, true),
					"Not Verified the Existing card Number in Payment page", "Verified the Existing card Number in Payment page", driver,	extentedReport, true);
	...
	public void TC_22001(String browser) throws Exception {

		String tcId = "TC_22001";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
		...
		try {
			...
			Log.softAssertThat(!RenewalPaymentCard.verifyExistingCardExpiryDate(testData.cardExpiryDate, extentedReport, true),
					"Not Verified the Existing card Expiry Datein Payment page", "Verified the Existing card Expiry Date in Payment page", driver,	extentedReport, true);
	...
	@Test(description = "Verify that Payment Amount on UXP must match with BO Policy Premium in Pure for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_22002(String browser) throws Exception {

		String tcId = "TC_22002";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	@Test(description = "Verify the “Payment Amount” on pay By Card screen is fetched correctly from Quotes screen & Payment selection screen for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_22003(String browser) throws Exception {

		String tcId = "TC_22003";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
	...
	public void TC_22004(String browser) throws Exception {

		String tcId = "TC_22004";
		final WebDriver driver = WebDriverFactory.get(browser);
		GetTestData testData = new GetTestData(sheetName, tcId);
		Log.testCaseInfo(testData.description + "<small><b><i>[" + browser + "]</b></i></small>");
