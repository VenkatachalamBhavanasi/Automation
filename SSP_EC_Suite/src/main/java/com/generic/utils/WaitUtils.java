...
public class WaitUtils {
    ...
    public static void waitForSpinner(final WebDriver driver) {
        ...
        try {
            ...
            (new WebDriverWait(driver, 60).pollingEvery(500, TimeUnit.MILLISECONDS).ignoring(NoSuchElementException.class, StaleElementReferenceException.class).withMessage("Spinners/page not loading")).until(spinnerLoad);
        } catch (Exception ex) {
