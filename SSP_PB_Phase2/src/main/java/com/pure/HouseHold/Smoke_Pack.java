...
public class Smoke_Pack extends BaseTest {
	...
	@Test(groups = {
	"Smoke" }, description = "To adding the Contents cover to existing Building cover policy through BUY option in SS and selecting payment method as Credit card ", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_001(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					...
					"Add Contents Cover is displayed in MTA intiate page",
					"Add Contents Cover is not displayed in MTA intiate page", driver, extentedReport, true);
			...
			Log.softAssertThat(!mtaPaymentPage.verifyBuyWithOtherCardButtonClickable(extentedReport),
					...
					"Buy with Another Card is enable when the Continuous Payments Question is not answered", driver,
					extentedReport, true);
			...
			Log.softAssertThat(mtaPaymentPage.verifyBuyWithOtherCardButtonClickable(extentedReport),
					...
					"Buy with Another Card is not enable when the Continuous Payments Question is answered", driver,
					extentedReport, true);
			...
			cardDetailsPage.enterCardDetails(testData.year, testData.cardHolderName, testData.cardNumber,
					extentedReport, true);
	...
	@Test(groups = {
	"Smoke" }, description = "To adding the Building cover to existing Contents cover policy through BUY option in SS and selecting payment method as Credit card  ", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_002(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					...
					"Add Building Cover cover is displayed in MTA intiate page",
					"Add Building Cover cover is not displayed in MTA intiate page", driver, extentedReport, true);

			mTAInitiatePage.selectChangeType(testData.typeOfChange, extentedReport, true);
			mTAInitiatePage.clickContinueButton(extentedReport, true);

			// Enter Add Contents cover details
			// AddContentsCoverPage addContentsCoverPage = new AddContentsCoverPage(driver,
			// extentedReport).get();
			...
			Log.softAssertThat(
					...
					"Add Building cover page is opens after clicking Continue button",
					"Add Building cover page is not opens after clicking Continue button", driver, extentedReport,
					true);
			...
			Log.softAssertThat(
					mtaQuoteDetailsPage.uielement.verifyPageElements(Arrays.asList("lblAmtAdditional"),
							mtaQuoteDetailsPage),
					"Insurance Premium amount is displayed when try to Add Building Cover on House hold Policy for change type : "
							+ testData.typeOfChange,
							"Insurance Premium amount is not displayed when try to Add Building Cover on House hold Policy for change type : "
									+ testData.typeOfChange,
									driver, extentedReport);
	...
	@Test(groups = {
	"Smoke" }, description = "To adding the specified items to existing Building cover & Contents cover policy through BUY option in SS and selecting payment method as Credit card ", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_003(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					...
					"Add Specified Items page is opens after clicking Continue button",
					"Add Specified Items page is not opens after clicking Continue button", driver, extentedReport,
					true);
			...
			/*
			 * Log.softAssertThat(
			 * addSpecifiedItemPage.verifyDeleteAndEditBtnInWithinHome(testData.
			 * arritemNameWH[0], extentedReport, true),
			 * "Add Specified item is verified in Within Home",
			 * "Add Specified item is not verified within Home", driver, extentedReport,
			 * true);
			 */

			addSpecifiedItemPage.clickYesOrNoAddAnotherItemInWithinHome(testData.arraddAnotherItemInWithinHome[0],
					extentedReport, true);
			 ...
			 * Log.softAssertThat(
			 * addSpecifiedItemPage.verifyDeleteAndEditBtnInWithinHome(testData.
			 * arritemNameWH[1], extentedReport, true),
			 * "Add Specified item is verified in Within Home",
			 * "Add Specified item is not verified within Home", driver, extentedReport,
			 * true);
			 */

			addSpecifiedItemPage.clickYesOrNoAddAnotherItemInWithinHome(testData.arraddAnotherItemInWithinHome[1],
					extentedReport, true);
			 ...
			 * Log.softAssertThat(
			 * addSpecifiedItemPage.verifyDeleteAndEditBtnInWithinHome(testData.
			 * arritemNameWH[2], extentedReport, true),
			 * "Add Specified item is verified in Within Home",
			 * "Add Specified item is not verified within Home", driver, extentedReport,
			 * true);
			 */

			// addSpecifiedItemPage.headersVerificationForTableInWithinHome(extentedReport,
			// true);
			addSpecifiedItemPage.clickYesOrNoAddAnotherItemInWithinHome(testData.arraddAnotherItemInWithinHome[2],
					extentedReport, true);
			...
			addSpecifiedItemPage.enterDescriptionOfItemOfSpecifiedItemsOutsideHome(testData.itemDecsriptionOH,
					extentedReport, false);
			...
			Log.softAssertThat(
					mtaQuoteDetailsPage.uielement.verifyPageElements(Arrays.asList("lblAmtAdditional"),
							mtaQuoteDetailsPage),
					"Insurance Premium amount is displayed when try to Add Specified items on House hold Policy for change type : "
							+ testData.typeOfChange,
							"Insurance Premium amount is not displayed when try to Add Specified itmes on House hold Policy for change type : "
									+ testData.typeOfChange,
									driver, extentedReport);
	...
	@Test(groups = {
	"Smoke" }, description = "To changing from existing Building cover policy to Contents cover policy and verifying the two Occupation detials entered in BO through BUY option in SS and selecting payment method as Credit card ", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_004(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					changeMyPropertyPage.uielement.verifyPageElements(Arrays.asList("txtTitleYourProperty"),
							changeMyPropertyPage),
					"Building cover page is opens after clicking Continue button",
					"Building cover page is not opens after clicking Continue button", driver, extentedReport, true);
			...
			// Property details
			changeMyPropertyPage.enterOtherdetailsPropToBeInsured(testData.dateOfResidence, testData.yearOfBuilt,
					extentedReport, true);
			...
			changeMyPropertyPage.enterTotalValueOfPreciousOrCostlyItems(testData.valueOfPreciousOrCostlyItems,
					extentedReport, true);
			changeMyPropertyPage.enterValueOfMostExpensiveItem(testData.valueOfMostExpensiveItem, extentedReport, true);
			changeMyPropertyPage.selectTypeOfHomeContentsCoverRequired(testData.typeOfHomeContentsCoverRequired,
					extentedReport, true);
			changeMyPropertyPage.selectTotalExcessRequiredC(testData.excessvalue, extentedReport, true);
			changeMyPropertyPage.clickYesOrNoBtnContentsSumRepresentReplacementAmount(
					testData.contentsSumRepresentReplacementAmount, extentedReport, true);

			changeMyPropertyPage.clickYesOrNoBtnPreviouslyContentsInsurances(testData.previouslyContentsInsurance,
					extentedReport, true);

			changeMyPropertyPage.selectNameOfPreviousInsurerC(testData.nameOfPreviousInsurer, extentedReport, true);
			changeMyPropertyPage.enterPolicyNumberOfPreviousInsuranceC(testData.numberOfPreviousInsurance,
					extentedReport, true);
			changeMyPropertyPage.enterExpiryDateOfPreviousInsuranceC(testData.expiryDateOfPreviousInsurance,
					extentedReport, true);
			changeMyPropertyPage.selectPayForYourPreviousInsuranceC(testData.payForYourPreviousInsurance,
					extentedReport, true);
			changeMyPropertyPage.selectContentsInsuranceWithoutClaiming(testData.noOfYearsWithoutClaimingValue,
					extentedReport, true);
			changeMyPropertyPage.clickNextContentsInformation(extentedReport, true);

			// enter Additional covers
			changeMyPropertyPage.enterCashKeptInYourHomeToBeInsured(testData.cashInYourHomeToBeInsured, extentedReport,
					true);
			...
			changeMyPropertyPage.clickYesOrNoAddPersonalPossessionsWithinHome(testData.addPersonalPossessionsWithinHome,
					extentedReport, true);
			/*
			 * changeMyPropertyPage.addSpecifiedItemwithinHome(testData.itemTypeWH,
			 * testData.itemValueWH, testData.itemDecsriptionWH, testData.saveAndCancelWH,
			 * extentedReport, true);
			 * 
			 * Log.softAssertThat(
			 * changeMyPropertyPage.verifyDeleteAndEditBtnInWithinHome(testData.itemNameWH,
			 * extentedReport, true), "Add Specified item is verified in Within Home",
			 * "Add Specified item is not verified within Home", driver, extentedReport,
			 * true);
			 * 
			 * changeMyPropertyPage.clickYesOrNoAddAnotherItemInWithinHome(testData.
			 * addAnotherItemInWithinHome, extentedReport, true);
			 * changeMyPropertyPage.clickNextNewSpecifiedItemWithinHome(extentedReport,
			 * true);
			 * changeMyPropertyPage.clickYesOrNoAddPersonalPossessionsOutsideHome(testData.
			 * addPersonalPossessionsOutsideHome, extentedReport, true);
			 * changeMyPropertyPage.addSpecifiedItemOutsideHome(testData.itemTypeOH,
			 * testData.itemValueOH, testData.itemDecsriptionOH, testData.saveAndCancelOH,
			 * extentedReport, true);
			 * 
			 * Log.softAssertThat(
			 * changeMyPropertyPage.verifyDeleteAndEditBtnInOutsideHome(testData.itemNameOH,
			 * extentedReport, true), "Add Specified item is verified outside Home ",
			 * "Add Specified item is not verified outside Home", driver, extentedReport,
			 * true);
			 */

			changeMyPropertyPage.clickYesOrNoAddPersonalPossessionsOutsideHome(
					testData.addPersonalPossessionsOutsideHome, extentedReport, true);
			...
			changeMyPropertyPage.verifyDeleteAndEditBtnInOccupation(testData.arroccupationType[0], extentedReport,
					true);
			// changeMyPropertyPage.clickCancelOccupation(extentedReport, true);

			changeMyPropertyPage.verifyDeleteAndEditBtnInOccupation(testData.arroccupationType[1], extentedReport,
					true);
			// changeMyPropertyPage.clickCancelOccupation(extentedReport, true);

			// changeMyPropertyPage.clickYesOrNoAddAnotherOccupation(testData.addAnotherOccupation,
			// extentedReport,true);
	...
	@Test(groups = {
	"Smoke" }, description = "To changing existing Contents cover policy to Building cover policy through BUY option in SS and selecting payment method as Credit card  ", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_005(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					mTAInitiatePage.uielement.verifyPageElements(Arrays.asList("changeMyProperty"), mTAInitiatePage),
					"Change My Property is displayed in MTA intiate page",
					"Change My Property is not displayed in MTA intiate page", driver, extentedReport, true);
			...
			Log.softAssertThat(
					changeMyPropertyPage.uielement.verifyPageElements(Arrays.asList("txtTitleYourProperty"),
							changeMyPropertyPage),
					"Contents cover page is opens after clicking Continue button",
					"Contents cover page is not opens after clicking Continue button", driver, extentedReport, true);
	...
	@Test(groups = {
	"Smoke" }, description = "To add the Occupation details to existing Contents cover policy and converting to Building cover policy through BUY option in SS and selecting payment method as Credit card  ", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	...
	public void TC_006(String browser) throws Exception {
		...
		try {
			...
			// Occupation details
			changeMyPropertyPage.clickYesOrNoAddAnotherOccupation(testData.addAnotherOccupation, extentedReport, true);
			changeMyPropertyPage.addOccupation(testData.occupation, testData.business, testData.employmentStatus,
			...
			Log.softAssertThat(
					mtaQuoteDetailsPage.uielement.verifyPageElements(Arrays.asList("lblAmtAdditional"),
							mtaQuoteDetailsPage),
					"Insurance Premium amount is displayed when try to Convert Building Cover on House hold Policy for change type : "
							+ testData.typeOfChange,
							"Insurance Premium amount is not displayed when try to Convert Building Cover on House hold Policy for change type : "
									+ testData.typeOfChange,
									driver, extentedReport);
	...
	@Test(groups = {
	"Smoke" }, description = "To changing from existing Buildings & Content cover policy to Contents cover with Specified items detials through BUY option in SS and selecting payment method as Credit card", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	...
	public void TC_007(String browser) throws Exception {
		...
		try {
			...
			/*
			 * Log.softAssertThat(
			 * changeMyPropertyPage.verifyDeleteAndEditBtnInWithinHome(testData.
			 * arritemNameWH[0], extentedReport, true),
			 * "Add Specified item is verified in Within Home",
			 * "Add Specified item is not verified within Home", driver, extentedReport,
			 * true);
			 ...
			 * true);
			 */
			changeMyPropertyPage.clickYesOrNoAddAnotherItemInWithinHome(testData.arraddAnotherItemInWithinHome[1],
					extentedReport, true);

			changeMyPropertyPage.clickNextNewSpecifiedItemWithinHome(extentedReport, true);

			changeMyPropertyPage.clickYesOrNoAddPersonalPossessionsOutsideHome(
					testData.addPersonalPossessionsOutsideHome, extentedReport, false);
			changeMyPropertyPage.addSpecifiedItemOutsideHome(testData.itemTypeOH, testData.itemValueOH,
					testData.itemDecsriptionOH, testData.saveAndCancelOH, extentedReport, true);
			changeMyPropertyPage.clickYesOrNoAddAnotherItemInOutsideHome(testData.addAnotherItemInOutsideHome,
					extentedReport, false);
			changeMyPropertyPage.clickContinue(extentedReport, true);
	...
	@Test(groups = {
	"Smoke" }, description = "To adding the Contents cover to existing Building cover policy through BUY option in SS and selecting payment method as premium finance", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_008(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					mtaQuoteDetailsPage.uielement.verifyPageElements(Arrays.asList("txtPaymentRequired"),
							mtaQuoteDetailsPage),
					"Insurance Premium amount is displayed when try to Add Contents Cover on House hold Policy for change type : "
							+ testData.typeOfChange,
							"Insurance Premium amount is not displayed when try to Add Contents Cover on House hold Policy for change type : "
	...
	@Test(groups = {
	"Smoke" }, description = "To adding the Building cover to existing Contents cover policy through BUY option in SS and selecting payment method as premium finance", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	...
	@Test(groups = {
	"Smoke" }, description = "To adding the specified items to existing Building cover & Contents cover policy through BUY option in SS and selecting payment method as premium finance", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_010(String browser) throws Exception {
		...
		try {
			...
			// AddContentsCoverPage addContentsCoverPage = new AddContentsCoverPage(driver,
			// extentedReport).get();
			// AddBuildingCoverPage addBuildingCoverPage = new AddBuildingCoverPage(driver,
			// extentedReport).get();
	...
	@Test(groups = {
	"Smoke" }, description = "To changing from existing Building cover policy to Contents cover policy and verifying the two Occupation detials entered in BO through BUY option in SS and selecting payment method as premium finance", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	...
	public void TC_011(String browser) throws Exception {
		...
		try {
			 ...
			 * true);
			 * 
			 * changeMyPropertyPage.clickYesOrNoAddAnotherItemInOutsideHome(testData.
			 * addAnotherItemInOutsideHome, extentedReport, true);
			 */
			changeMyPropertyPage.clickContinue(extentedReport, true);
			...
			Log.softAssertThat(
					mtaQuoteDetailsPage.uielement.verifyPageElements(Arrays.asList("refundAmt"), mtaQuoteDetailsPage),
					"Insurance Premium amount is displayed when try to Change My Property on House hold Policy for change type : "
							+ testData.typeOfChange,
							"Insurance Premium amount is not displayed when try to Change My Property on House hold Policy for change type : "
									+ testData.typeOfChange,
	...
	@Test(groups = {
	"Smoke" }, description = "To changing existing Contents cover policy to Building cover policy through BUY option in SS and selecting payment method as premium finance", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	...
	@Test(groups = {
	"Smoke" }, description = "To add the Occupation details to existing Contents cover policy and converting to Building cover policy through BUY option in SS and selecting payment method as premium finance", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	...
	@Test(groups = {
	"Smoke" }, description = "To changing from existing Buildings & Content cover policy to Contents cover policy with Specified items detials through BUY option in SS and selecting payment method as premium finance", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	...
	public void TC_014(String browser) throws Exception {
		...
		try {
			...
			/*
			 * Log.softAssertThat(
			 * mTAInitiatePage.uielement.verifyPageElements(Arrays.asList(
			 * "addSpecifiedItems"), mTAInitiatePage),
			 * "Add Specified Items page is displayed in MTA intiate page",
			 * "Add Specified Items page is not displayed in MTA intiate page", driver,
			 * extentedReport, true);
			 */
	...
	@Test(groups = {
	"Smoke" }, description = "Verify that the new card details will be set as default if user doesn't have any existing cards and selected 'Yes' for the CPA question", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_015(String browser) throws Exception {
		...
		try {
			...
			renewalPaymentCard.clickYesButtonPopupMessage(extentedReport, true);
	...
	@Test(groups = {
	"Smoke" }, description = "Verify that the new card details will not be set as default if user doesn't have any existing cards and selected 'NO' for the CPA question", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	...
	@Test(groups = {
	"Smoke" }, description = "If existing card is selected ‘Buy’ button will be enabled to allow the user to pay with the existing card and the existing card will not be set as the default if processed", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_17(String browser) throws Exception {
	...
	@Test(groups = {
	"Smoke" }, description = "If existing card is selected ‘Buy’ button will be enabled to allow the user to pay with the existing card and the existing card will be set as the default if processed", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_18(String browser) throws Exception {
	...
	/*
	@Test(groups = {
	"Smoke" }, description = "Verify that user can capture the bank details only if they are not available and  when Business of this Policy was already paid via credit card option for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_19(String browser) throws Exception {
	...
	@Test(groups = {
	"Smoke" }, description = " Verify that for PF the new card details will be set as default if user doesn't have any existing cards and selected 'Yes' for the CPA question with deposit amount for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_20(String browser) throws Exception {
	...
	@Test(groups = {
	"Smoke" }, description = "Verify that for PF the new card details will not be set as default if user doesn't have any existing cards and selected 'No' for the CPA question with deposit amount for Motor policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_21(String browser) throws Exception {
	...
	@Test(groups = {
	"Smoke" }, description = "If existing card is selected ‘Buy’ button will be enabled to allow the user to pay with the existing card and the existing card will be set as the default if processed with PF", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_22(String browser) throws Exception {
		...
		try {
			...
			renewalPaymentPage.selectCheckBoxForCard(testData.cardName, extentedReport, true);

			renewalPaymentPage.defaultCheckBoxForCard(testData.cardName, extentedReport, true);
			...
			renewalPaymentPage.clickBuyButton(extentedReport);
	...
	@Test(groups = {
	"Smoke" }, description = "If existing card is selected ‘Buy’ button will be enabled to allow the user to pay with the existing card and the existing card will not be set as the default if processed with PF", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_23(String browser) throws Exception {
	...
	*/
	...
	@Test(groups = {
	"Smoke" }, description = "If existing card is selected ‘Buy’ button will be enabled to allow the user to pay with the existing card and the existing card will not be set as the default if processed", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_26(String browser) throws Exception {
	...
	@Test(groups = {
	"Smoke" }, description = "If existing card is selected ‘Buy’ button will be enabled to allow the user to pay with the existing card and the existing card will be set as the default if processed", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_27(String browser) throws Exception {
	...
	/*
	@Test(groups = {
	"Smoke" }, description = "Verify that user can capture the bank details only if they are not available and  when Business of this Policy was already paid via credit card option for HH policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_28(String browser) throws Exception {
	...
	@Test(groups = {
	"Smoke" }, description = " Verify that for PF the new card details will be set as default if user doesn't have any existing cards and selected 'Yes' for the CPA question with deposit amount for HH policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_29(String browser) throws Exception {
	...
	@Test(groups = {
	"Smoke" }, description = "Verify that for PF the new card details will not be set as default if user doesn't have any existing cards and selected 'No' for the CPA question with deposit amount for HH policies.", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_30(String browser) throws Exception {
	...
	@Test(groups = {
	"Smoke" }, description = "If existing card is selected ‘Buy’ button will be enabled to allow the user to pay with the existing card and the existing card will be set as the default if processed with PF", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_31(String browser) throws Exception {
	...
	@Test(groups = {
	"Smoke" }, description = "If existing card is selected ‘Buy’ button will be enabled to allow the user to pay with the existing card and the existing card will not be set as the default if processed with PF", dataProviderClass = DataProviderUtils.class, dataProvider = "PureBroker")
	public void TC_32(String browser) throws Exception {
