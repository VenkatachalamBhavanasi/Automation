...
public class UXP_SS extends BaseTest {
    ...
    public void tcHoodSS001(String browser) throws Exception {
        ...
        HashMap<String, String> testData = DataUtils.testDatabyID("tcHoodSS001", className);
        ...
        if ("device".equalsIgnoreCase(test_type)) {
            ...
            browserwithos = browsername + "_" + device;
        } else {
            String browsername = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("browser");
        ...
        ExtentTest extentedReport = Log.testCaseInfo("Self Service - tcHoodSS001" + "[" + test + "]", "SS - tcHoodSS001 - " + description + " [" + browserwithos + "]", test, "UXP_NFR Team");
    ...
    public void tcHoodSS002(String browser) throws Exception {
        ...
        String env = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("env");
        String className = "UXP_SS_" + env;
        HashMap<String, String> testData = DataUtils.testDatabyID("tcHoodSS002", className);
        String description = testData.get("Description").toString();
        String username = testData.get("UserName").toString();
        String password = testData.get("Password").toString();
        String customername = testData.get("Customer Name").toString();
        ...
        ExtentTest extentedReport = Log.testCaseInfo("Self Service - tcHoodSS002" + "[" + test + "]", "SS - tcHoodSS002 - " + description + " [" + browserwithos + "]", test, "UXP_NFR Team");
        ...
        try {
            ...
            if (!getquotepage.verifyDetails(customername)) {
                ...
                Log.pass("Step-7: Customer Details Verified!", driver, extentedReport, true);
            }
    ...
    public void tcHoodSS003(String browser) throws Exception {
        ...
        String env = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("env");
        String className = "UXP_SS_" + env;
        HashMap<String, String> testData = DataUtils.testDatabyID("tcHoodSS003", className);
        String description = testData.get("Description").toString();
        String username = testData.get("UserName").toString();
        String password = testData.get("Password").toString();
        String customername = testData.get("Customer Name").toString();
        ...
        ExtentTest extentedReport = Log.testCaseInfo("Self Service - tcHoodSS003" + "[" + test + "]", "SS - tcHoodSS003 - " + description + " [" + browserwithos + "]", test, "UXP_NFR Team");
