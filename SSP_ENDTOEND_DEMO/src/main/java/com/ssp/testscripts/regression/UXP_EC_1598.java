...
public class UXP_EC_1598 extends BaseTest {
	...
	@Test(description = "To check Mailing Address checkbox is checked for the address which has marked Yes for mailing address", dataProviderClass = com.ssp.support.DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
	...
	public void BS_004(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(manageContactDetailsPg.verifyManageContactDetailsFields(),
					...
					driver, extentedReport, true);
			manageContactDetailsPg.clickAddNewAddressButton(extentedReport, true);
			manageContactDetailsPg.enterNewAddressDetails("AB10 1AH", testData, "Business", extentedReport, true);
