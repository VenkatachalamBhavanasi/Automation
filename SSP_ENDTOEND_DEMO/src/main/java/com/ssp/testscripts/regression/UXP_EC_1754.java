...
public class UXP_EC_1754 extends BaseTest {
	...
	public void TC_474(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(Utils.verifyTextEquals(strFnameValue, ""), "The Firstname field become empty",
					"The first name field is not empty", driver, extentedReport, true);
			Log.softAssertThat(Utils.verifyTextEquals(strLnameValue, ""), "The Lastname field become empty",
	...
	public void TC_477(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(Utils.verifyTextEquals(strVersion, strVersionToVerify),
					"The version is '" + strVersion + "' as expected", "The version is not correct : " + strVersion,
					driver, extentedReport, true);

			Log.softAssertThat(Utils.verifyTextEquals(strTitle, strTitleToVerify),
					"The title is '" + strTitle + "' as expected", "The title is not correct : " + strTitle, driver,
					extentedReport, true);

			Log.softAssertThat(Utils.verifyTextEquals(strLanguage, strLangToVerify),
	...
	public void TC_478(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(Utils.verifyTextEquals(strUserLogin, "Welcome " + loginName),
