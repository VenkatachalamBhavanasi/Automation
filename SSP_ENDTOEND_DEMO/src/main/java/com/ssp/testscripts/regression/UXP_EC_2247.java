...
public class UXP_EC_2247 extends BaseTest {
	...
	public void TC_517(String browser) throws Exception {
		...
		String payorFirstName = Utils.getRandomCharacters("alpha", 5) + testData.get("First Name") + "Payor";
		String payorLastName = Utils.getRandomCharacters("alpha", 5) + testData.get("First Name") + "Payor";
	...
	public void TC_535(String browser) throws Exception {
		...
		String newPayorFirstName = Utils.getRandomCharacters("alpha", 5);
		String newPayorLastName = Utils.getRandomCharacters("alpha", 5);
	...
	public void TC_536(String browser) throws Exception {
		...
		try {
			...
			String accName = Utils.getRandomCharacters("alpha", 5);
    ...
    public void TC_519(String browser) throws Exception {
			...
			String firstName = Firstletter + Utils.getRandomCharacters("alpha", 4);
            String LastName=LNFirstLetter+Utils.getRandomCharacters("alpha", 4);
            testData.put("First Name", firstName);
            testData.put("Last Name", LastName);
            
            HashMap<String, String> testData1 = getTestData(tcId);
            
			String firstName1 = Firstletter + Utils.getRandomCharacters("alpha", 4);
            String LastName1=LNFirstLetter+Utils.getRandomCharacters("alpha", 4);
            testData1.put("First Name", firstName1);
            testData1.put("Last Name", LastName1);
            
            HashMap<String, String> testData2 = getTestData(tcId);
			String firstName11 = Firstletter + Utils.getRandomCharacters("alpha", 4);
            String LastName11=LNFirstLetter+Utils.getRandomCharacters("alpha", 4);
	...
	public void BS_005(String browser) throws Exception {
		...
		try {
			...
			String newAccName = Utils.getRandomCharacters("alpha", 5);
