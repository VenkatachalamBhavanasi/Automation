...
import com.ssp.pages.uxp.BillingAdjustmentPage;
...
public class UXP_EC_1608 extends BaseTest {
	...
	public void TC_667(String browser) throws Exception {
		...
		try {
			...
			preferredPaymentDay = "" + Utils.getRandomNumberBetween(1, 31);
			testData.put("Preferred Payment Day", preferredPaymentDay);
	...
	public void TC_681_685(String browser) throws Exception {
		...
		try {
			...
			String accName2 = Utils.getRandomCharacters("alpha", 5);
			...
			String accName3 = Utils.getRandomCharacters("alpha", 5);
	...
	public void TC_692(String browser) throws Exception {
		...
		try {
			...
			// Cancel payment
			custdashboardpage = NewQuotePage.cancelPayment(extentedReport);
			Log.softAssertThat(
					custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage),
					"Customer Dashboard page is verified", "Customer Dashboard page is not verified", driver,
					extentedReport, true);
	...
	public void TC_693(String browser) throws Exception {
		...
		try {
			...
			// Save Quote
			custdashboardpage = NewQuotePage.saveQuote(extentedReport);
			Log.softAssertThat(
					custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage),
					"Customer Dashboard page is verified", "Customer Dashboard page is not verified", driver,
					extentedReport, true);
	...
	public void TC_699_700_707_708_713_716(String browser) throws Exception {
		...
		try {
			...
			NewQuotePage.clickReCalculate(extentedReport);
			testData = NewQuotePage.grabPaymentDetailsFromAdjustmentCoverTab(testData, extentedReport, true);
			NewQuotePage.clickBuy(extentedReport);
			NewQuotePage.selectAvalilableAdjReasons("Add Cover", extentedReport, false);
			NewQuotePage.clickAddMTA(extentedReport, false);
			NewQuotePage.clickAddAllMTANextButton(extentedReport, true);
			Log.softAssertThat(
					NewQuotePage.verifyMTAAdjustmentRadioButtons(false, extentedReport, true),
			...
			Log.softAssertThat(NewQuotePage.verifyChangePayorDisabled(),
			...
			Log.softAssertThat(NewQuotePage.verifyPaymentPlanDisabled(),
			...
			Log.softAssertThat(NewQuotePage.verifyPaymentMethodDisabled(),
			...
			Log.softAssertThat(
					NewQuotePage.verifyPaymentScheduleTable(adjustmentOption, testData, extentedReport, true),
					"The 'Payment Schedule' table verification is successful",
					"The 'Payment Schedule' table verification is unsuccessful", driver, extentedReport, true);
			
			adjustmentOption = "Spread over Instalments";
			NewQuotePage.selectSpreadOverInstallmentsRadioButton(extentedReport);;
			Log.softAssertThat(
					NewQuotePage.verifyPaymentScheduleTable(adjustmentOption, testData, extentedReport, true),
					"The 'Payment Schedule' table verification is successful",
					"The 'Payment Schedule' table verification is unsuccessful", driver, extentedReport, true);
			...
			NewQuotePage.tickCustomerAgreesCheckbox(extentedReport);
			Log.softAssertThat(
					NewQuotePage.verifyAcceptButtonPresence(extentedReport),
	...
	public void TC_709_712_724(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
					NewQuotePage.verifyMTAAdjustmentRadioButtons(true, extentedReport, true),
					"Verified that radio buttons of 'MTA Adjustment' section are displayed as expected",
					"The radio buttons of 'MTA Adjustment' section are not displayed as expected",
					driver, extentedReport, true);
			
			// Acceptance tab - Payment details verification
			Log.softAssertThat(NewQuotePage.verifyPaymentDetailsAtAdjustmentPaymentAcceptanceTab(testData, extentedReport, true),
					"Verified that the payment details at Acceptance tab matches with the details at Cover tab",
					"The payment details at Acceptance tab does not match with the details at Cover tab", driver,
					extentedReport, true);
	...
	public void TC_714_718_720(String browser) throws Exception {
		...
		try {
			...
			custdashboardpage = NewQuotePage.clickReturnToCustomerDashboard(extentedReport);
			Log.softAssertThat(
					custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage),
					"Customer Dashboard page is verified", "Customer Dashboard page is not verified", driver,
					extentedReport, true);
	...
	public void TC_877(String browser) throws Exception {
		...
		try {
			...
			// Acceptance tab - Payment details verification
			Log.softAssertThat(
					NewQuotePage.verifyPaymentDetailsAtAdjustmentPaymentAcceptanceTab(testData, extentedReport, true),
					"Verified that the payment details at Acceptance tab matches with the details at Cover tab",
					"The payment details at Acceptance tab does not match with the details at Cover tab", driver,
					extentedReport, true);
	...
	public void TC_882(String browser) throws Exception {
		...
		try {
			...
			// Edit Quote
			NewQuotePage NewQuotePage = custdashboardpage.clickEditfromManagePolicyDropdown(extentedReport, true);

			Log.softAssertThat(
					NewQuotePage.uielement.verifyPageElements(Arrays.asList("btnBuyEditQuote"), NewQuotePage),
					...
					true);
			NewQuotePage.clickBuyEditQuote(extentedReport);
			NewQuotePage.selectPaymentPlan("Monthly", extentedReport);
			NewQuotePage.selectPaymentMethod("Direct Debit", extentedReport);
			
			// Acceptance tab - Payment details verification
			Log.softAssertThat(
					NewQuotePage.verifyPaymentDetailsAtEditQuoteAcceptanceTab(testData, extentedReport, true),
					"Verified that the payment details at Acceptance tab matches with the details at Cover tab",
			...
			testData.put("Preferred Payment Day", preferredPaymentDay);
			Log.softAssertThat(
					NewQuotePage.verifyPaymentScheduleTable("No Adjustment", testData, extentedReport, true),
					"The 'Payment Schedule' table verification is successful",
					"The 'Payment Schedule' table verification is unsuccessful", driver, extentedReport, true);
