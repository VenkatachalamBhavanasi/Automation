...
import com.ssp.pages.uxp.ManageContactDetailsPage;
import com.ssp.pages.uxp.NewQuotePage;
import com.ssp.pages.uxp.SearchPage;
import com.ssp.pages.uxp.SuspendBillingPage;
...
public class UXP_EC_1613 extends BaseTest {
  ...
  public void TC_337_340_342_374_375(String browser) throws Exception {
    ...
    try {
       ...
       * carddetailspage.clickbuy(extentedReport, true); Log.
       * message("Entered Card Details and Navigated to Verificaion page", driver, extentedReport,
       * true);
       * 
  ...
  // Not in Scope for ASDA
  // @Test(description = "To check that the user is allowed to modify the
  // 'Change Payment Plan / Method' details in the 'Acceptance' screen. To
  // check that the user is allowed to make payment in accordance with payment
  // method chosen in the 'Acceptance' screen", dataProviderClass =
  // DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_366_369_371(String browser) throws Exception {
    // Get the web driver instance
    String tcId = "TC_366_369_371";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        newquotepage.selectPaymentPlan("PCL ASDA Staff", extentedReport);
        newquotepage.selectPaymentMethod("Direct Debit", extentedReport);
        Log.softAssertThat(
            newquotepage.selectPayment("PCL ASDA Staff", testData, true, extentedReport),
  ...
  public void BS_653_692(String browser) throws Exception {
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        NewQuotePage.selectAvalilableAdjReasons(testData.get("MTAdjReason"), extentedReport, false);
        ...
        custdashboardpage = NewQuotePage.confirmPaymentOnMTA("MTA", testData, extentedReport);
        ...
        if (custdashboardpage.verifyTransactionStatus("Renewal", "Inactive", extentedReport,
            true)) {

          Log.pass("Policy status changed to review required after MTA", driver, extentedReport,
              true);
        } else {
          Log.fail("Policy status is not changed to review required after MTA", driver,
              extentedReport, true);
        }
  ...
  public void BS_652_683(String browser) throws Exception {
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        newquotepage.clickRenewalQuoteBuy(extentedReport);
        newquotepage.clickCustomerPreferenceNext(extentedReport);
        newquotepage.enterTrasactionID(extentedReport);
        ...
        Log.softAssertThat(policyDetails.get("Status").toString().equalsIgnoreCase("Accepted"),
            "Policy status displaying as accepted", "Policy status not displaying as accepted");
        custdashboardpage.clickManagePolicy(extentedReport);
        // custdashboardpage.selectTabDropdown("Manage Policy",
        ...
        HashMap<String, String> policyDetailsrnl1 = custdashboardpage.getPolicyURN(extentedReport);
        Log.softAssertThat(
            policyDetailsrnl1.get("Position").toString().equalsIgnoreCase("NewBusiness"),
  ...
  // Test case got descoped due to known monthly premium issue during RNL

  // @Test(groups = "Business_Scenario", description = " Reinstate a cancelled
  // direct debit renewal policy, then attempt an MTA", dataProviderClass =
  // DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        Log.softAssertThat(
            ...
            "Change payor and customer name dispaying as same",
            "Change payor and customer name not dispaying as same");
        newquotepage.selectPaymentPlan("PCL ASDA", extentedReport);
        newquotepage.selectPaymentMethod("Premium Finance", extentedReport);
        ((JavascriptExecutor) driver).executeScript("window.scrollBy(0,400)");
        newquotepage.doEligibilityCheck(testData, true, extentedReport);
        newquotepage.clickContinue(extentedReport);

        // Validation for Bank Details
        newquotepage.validationCheck(testData, true, extentedReport);
        Log.message("Entered details for validation check", driver, extentedReport, true);

        // Insured Documents Section
        newquotepage.confirmContent(extentedReport);
        ...
        custdashboardpage.enterRequestCancellationDetails("No Refund", "Better quote elsewhere",
            extentedReport);
        Log.softAssertThat(
            custdashboardpage.uielement.verifyPageElementsDoNotExist(
                Arrays.asList("drpManageRenewals"), custdashboardpage),
        ...
        // Click on buy button
        NewQuotePage.clickBuy(extentedReport);
        NewQuotePage.selectAvalilableAdjReasons("Change contact details", extentedReport, false);
        NewQuotePage.clickAddMTA(extentedReport, false);
        NewQuotePage.clickAddAllMTANextButton(extentedReport, true);
        NewQuotePage.enterTrasactionIdForSTA(extentedReport);
        custdashboardpage = NewQuotePage.confirmPaymentOnMTA("MTA", testData, extentedReport);
  ...
  public void BS_661_684(String browser) throws Exception {
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        newquotepage.clickRenewalQuoteBuy(extentedReport);
        BuyQuotePage buyQuotePage = new BuyQuotePage(driver, extentedReport);
        buyQuotePage.clicksave_LapsebuttoninAcceptancepage("", quoteDescription1, "Lapse",
            extentedReport);
        Log.softAssertThat(
            custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"),
                custdashboardpage),
  ...
  public void BS_716(String browser) throws Exception {
    ...
    try {
      ...
      Log.softAssertThat(
          custdashboardpage.verifyTabUnderPolicyHolder("Manage Renewals", extentedReport, true),
          "Manage Renewals tab displayed after reinstating a policy",
          "Manage Renewals tab is not displayed after reinstating a policy");
    } catch (Exception e) {
      Log.exception(e, driver, extentedReport);
    } finally {
      Log.endTestCase(extentedReport);
  ...
  public void BS_714_715_719_718(String browser) throws Exception {
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        buyQuotePage.clicksave_LapsebuttoninAcceptancepage("", quoteDescription2, "Save",
            extentedReport);
        custdashboardpage.clickRenewalQuoteVariations(extentedReport, true);
        Log.softAssertThat(
        ...
        custdashboardpage.ClickOptionInRenewalQuoteVariations(quoteDescription2, extentedReport,
            true);
        buyQuotePage.clicksave_LapsebuttoninAcceptancepage("Reviewed", quoteDescription3, "Save",
            extentedReport);
        custdashboardpage.clickRenewalQuoteVariations(extentedReport, true);
        Log.softAssertThat(
      ...
      for (int i = 0; i < coversToAdd.length; i++) {
        ...
        String[] coverType = coversToAdd[i].split("_");
        if (BoolVal != false) {
          Log.message(coverType[2] + " " + coverType[0] + "_" + coverType[1]
      ...
      /*
       * BuyQuotePage buyquotepage = new BuyQuotePage(driver, extentedReport);
       * buyquotepage.clicksave_LapsebuttoninAcceptancepage("Reviewed", "Quote Description", "Save",
       * extentedReport);
       */
      ...
      Log.message("Quote Variations Size: " + QuoteVariationsetails.size());
      ...
      homePage = custdashboardpage.clickCompleteButton();
      Log.pass("User able to complete the quote variations and navigated to Home page. ",
          extentedReport);
  ...
  public void BS_710_711_712_717(String browser) throws Exception {
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        Log.softAssertThat(buyQuotePage.verifyAcceptButton(extentedReport),
            "Accept button is enabled as expected after entering transaction ID",
            "Accept button isn't enabled after entering transaction id", driver, extentedReport,
            true);
        ...
        manageContactDetailsPg.enterNewAddressDetails("AB10 1AH", testData, "Home", extentedReport,
            true);
  ...
  // @Test(groups = "Business_Scenario", description = "Check that able Renew
  // the policy and able to pay in the original payment method",
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        BuyQuotePage buyQuotePage =
            custdashboardpage.performRenewals_QuoteVariation(extentedReport, true);
        /*
         * // Select card type buyQuotePage.takePayment(extentedReport); carddetailspage =
         * buyQuotePage.selectVisacard(extentedReport); Log.pass("Selected VISA Card", driver,
         * extentedReport, true);
         * 
         * // Enter Card Details carddetailspage.enterCardNumber(testData, extentedReport, true);
         * carddetailspage.selectExpiry(testData, extentedReport, true);
         ...
         * carddetailspage.enterName(testData, extentedReport, true);
         * carddetailspage.clickbuy(extentedReport, true); Log.
         * pass("Entered Card Details and Navigated to Verificaion page" , driver, extentedReport,
         * true);
         * 
         * // Click continue button buyQuotePage =
         * carddetailspage.clickContinueButton_buyQuote(extentedReport);
  ...
  // @Test(groups = "Business_Scenario", description = "Verify that after
  // renewal do MTA and pay in alternative payment method", dataProviderClass
  // = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void BS_693(String browser) throws Exception {
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        buyQuotePage.selectPaymentPlan("PCL ASDA", extentedReport);
        buyQuotePage.selectPaymentMethod("Premium Finance", extentedReport, true);
        ((JavascriptExecutor) driver).executeScript("window.scrollBy(0,400)");
        NewQuotePage.doEligibilityCheck(testData, true, extentedReport);
        NewQuotePage.clickContinue(extentedReport);
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        Log.softAssertThat(buyQuotePage.verifyDefaultTab("Acceptance", extentedReport, true),
            ...
            driver, extentedReport, true);
        // update payment method
        buyQuotePage.selectPaymentPlan("Annual Payment Plan", extentedReport);
        ...
        Log.softAssertThat(
            buyQuotePage.uielement.verifyPageElements(Arrays.asList("chkBx_toMakePayment"),
                buyQuotePage),
            "Confirm checkbox to take payment Button is present after change new payer ",
            "Confirm checkbox to take payment Button is not present after change new payer ",
            driver, extentedReport, true);
      } else {
        Log.fail(
            "Failed - NB Policy Created in " + policyDetails.get("Status").toString()
  ...
  // Descoped the test case, due to the known issue "Monthly premium wont
  // generate during RNL"
  // @Test(groups = "Business_Scenario", description = "On renewal invite
  // check that direct debit agreement is enabled and can be ticked ",
  // dataProviderClass = DataProviderUtils.class, dataProvider =
  // "ssBVTDataProvider")
  ...
  // @Test(groups = "Business_Scenario", description = "Check that we can add
  // or remove cover during renewal invite, including add-ons",
  // dataProviderClass = DataProviderUtils.class, dataProvider =
  // "ssBVTDataProvider")
  ...
  // Not in scope for ASDA renewals
  // @Test(groups = "Business_Scenario", description = "Check that a policy
  // which is previously flagged with suspend billing during billing
  // adjustment is forced out of renewal cycle (need to check that the product
  // is set up with the referral rules that say this is a referral reason",
  // dataProviderClass = DataProviderUtils.class, dataProvider =
  // "ssBVTDataProvider")
  ...
  // Not in Scope as it's related Direct Debit - outstaning payment
  // @Test(groups = "Business_Scenario", description = "Invite Renewal for a
  // policy with outstanding debt", dataProviderClass =
  // DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  ...
  // Not in scope for ASDA renewals
  // @Test(groups = "Business_Scenario", description = "Check preferred
  // payment date is still in place on renewal ", dataProviderClass =
  // DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  ...
  public void BS_721_663(String browser) throws Exception {
    ...
    try {
      ...
      /*
       * // Select card type newquotepage.takePayment(extentedReport); CardDetailsPage
       * carddetailspage = newquotepage.selectVisacard(extentedReport); // Enter Card Details
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        if (buyQuotePage.verifyPaymentPlanRenewal(paymentPlan))
          Log.pass("Existing Payment plan is not changed during renewal as expected", driver,
              extentedReport, true);
        else
          Log.fail("Existing Payment plan is changed unexpectedly during renewal", driver,
              extentedReport, true);
  ...
  // @Test(groups = "Business_Scenario", description = "Check a policy that
  // has had do not invite flag unticked during MTA goes to red ‘R’",
  // dataProviderClass = DataProviderUtils.class, dataProvider =
  // "ssBVTDataProvider")
  public void TC_662(String browser) throws Exception {
    String tcId = "TC_662";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        custdashboardpage.clickMidTermAdjustment(extentedReport);
        custdashboardpage.enterDateForMTA(extentedReport);
        custdashboardpage.selectMidTermAdjReason(testData.get("MTAdjReason").toString(),
            extentedReport);
        custdashboardpage.clickMidTermContinue(extentedReport);
        ...
        if (!NewQuotePage.validateReviewRenewalFields("Automatic Review", "checked", extentedReport,
          ...
          NewQuotePage.selectAvalilableAdjReasons(testData.get("MTAdjReason"), extentedReport,
              false);
          NewQuotePage.clickAddMTA(extentedReport, false);
          NewQuotePage.clickAddAllMTANextButton(extentedReport, true);
          NewQuotePage.enterTrasactionIdForSTA(extentedReport);
  ...
  @Test(
      description = "To check that the following options are displayed on clicking the Manage Renewals tab, If renewal has been invited against a policy ,Lapse Quote",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_348(String browser) throws Exception {
    String tcId = "TC_348";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      // Create New Quote
      custdashboardpage.clickNewQuote(true, extentedReport);
      custdashboardpage.enterNewQuotePastDate(10, 1, extentedReport, true);
      custdashboardpage.selectNewQuoteDetails(testData, extentedReport, true);
      NewQuotePage newquotepage = custdashboardpage.clickContinueQuote(true, extentedReport);
      ...
      // check for policy status and Invite Renewal
      HashMap<String, String> policyDetails = custdashboardpage.getPolicyURN(extentedReport);
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        // Get and Buy Quote
        newquotepage.clickGetQuote(extentedReport);
        newquotepage.clickQuoteSave("Renew", "Quoted renew policy", extentedReport);
        ...
        Log.softAssertThat(
            ...
            "Lapse Quote option is displayed under Manage Renewal dropdown after Invite Renewal ",
            "Lapse Quote option is not  displayed under Manage Renewal dropdown after Invite Renewal",
            driver, extentedReport, true);

        Log.softAssertThat(
            custdashboardpage.verifygyedoutOptionInManageRenewals("Invite Renewal", extentedReport,
                true),
            "Invite Renewal option is  greyed out under Manage Renewal dropdown after Invite Renewal ",
            "Invite Renewal  option is not  greyed out under Manage Renewal dropdown after Invite Renewal",
            driver, extentedReport, true);
        Log.softAssertThat(
            custdashboardpage.verifyTransactionStatus("Renewal", "Inactive", extentedReport, true),
            "Renewal of selected policy is saved as ‘Review Required’ with a status of inactive",
            "Renewal of selected policy is not saved as ‘Review Required’ with a status of inactive",
            driver, extentedReport, true);
  ...
  @Test(
      description = "To check that the policy & payment details is displayed by default in the Acceptance screen, if the User selects Buy option in the Price presentation page ",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_365(String browser) throws Exception {
    String tcId = "TC_365";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      // Select Payment
      newquotepage.selectPayment(testData, true, extentedReport);
      newquotepage.getPayorname(extentedReport, testData);

      String Premium = newquotepage.getPremiumAtAcceptancePage(extentedReport);
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        Log.softAssertThat(
            ...
            driver, extentedReport, true);
        custdashboardpage.clickManageRenewal(extentedReport, true);
        custdashboardpage.ClickOptionInManageRenewals("Invite Renewal", extentedReport, true);
        ...
        Log.softAssertThat(
            newquotepage.verifyAnnualPaymentDetailsAtAcceptanceTab(testData, extentedReport,
                Premium, true),
            "Policy & payment details is displayed by default in the Acceptance screen",
            "Policy & payment details is not displayed by default in the Acceptance screen", driver,
            extentedReport, true);
  ...
  @Test(
      description = "To check that the user is allowed to update the policy details in the Data capture screen",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_356(String browser) throws Exception {
    String tcId = "TC_356";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        custdashboardpage.performRenewals_LapseRenewal("Invite Renewal", extentedReport, true);
        HashMap<String, String> policyDetails1 = new HashMap<String, String>();
        policyDetails1.put("Cover", "Buildings and Contents");
        policyDetails1.put("No of Bedrooms", "3");
        policyDetails1.put("YOB", "1990");
        policyDetails1.put("Property Type", "18");
        policyDetails1.put("Brand Name", "ASDA");

        for (Entry<String, String> s : policyDetails1.entrySet()) {
          System.out.println(s.getKey() + " " + s.getValue());

        }
        newquotepage.enterPolicyDetails(policyDetails1, true, extentedReport);
        newquotepage.clickNextOne(extentedReport);
        newquotepage.clickNextTwo(extentedReport);
        newquotepage.clickView(extentedReport);
        newquotepage.clickAgree(extentedReport);
        ...
        Log.softAssertThat(newquotepage.verifyDataCapturePage(policyDetails1, true, extentedReport),
            "Data Capture page details are updated", "Data Capture page details are not updated",
            driver, extentedReport, true);
      }
  ...
  @Test(
      description = "To check that the Lapsed Renewal is displayed with a position as 'Renewal' and status as 'Inactive', when user clicks on 'Lapse' button",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_377(String browser) throws Exception {
    String tcId = "TC_377";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        newquotepage.clickRenewalQuoteBuy(extentedReport, "");
        newquotepage.clickCustomerPreferenceNext(extentedReport);
        newquotepage.clicksave_LapsebuttoninAcceptancepage("", "", "lapse", extentedReport);

        Log.softAssertThat(
            custdashboardpage.verifyTransactionStatus("Renewal", "Inactive", extentedReport, true),
            "Lapse of selected policy is saved as ‘Renewal’ with a status of 'Inactive'",
            "Lapse of selected policy is not saved as ‘Renewal’ with a status of 'Inactive'",
            driver, extentedReport, true);
        /*
         ...
         * , driver, extentedReport, true); homePage.clickTakeCall(extentedReport);
         * homePage.clickMyBrands(brandname, extentedReport);
         * 
         * Log.softAssertThat(searchPage.uielement.verifyPageElements(
         * Arrays.asList("txtPolicyNumber"), searchPage), "Search Page Verified",
  ...
  @Test(
      description = "To check that the user is allowed to edit the saved renewal quote with the 'Review Required status, onclicking on the quote variation in 'Manage quote variation' tab ",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_385(String browser) throws Exception {
    String tcId = "TC_385";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
  ...
  @Test(description = "To check the Invite Renewal for a selected policy  ",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_373(String browser) throws Exception {
    ...
    try {
      ...
      // Create New Quote
      custdashboardpage.clickNewQuote(true, extentedReport);
      custdashboardpage.enterNewQuotePastDate(20, 1, extentedReport, true);
      custdashboardpage.selectNewQuoteDetails(testData, extentedReport, false);
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        Log.softAssertThat(policyDetailsrnl.get("Status").toString().equalsIgnoreCase("Accepted"),
            "Policy status displaying as accepted", "Policy status not displaying as accepted");

        if (policyDetailsrnl.get("Position").toString().equalsIgnoreCase("Renewal"))
          Log.pass("Policy position is displaying as Renewal as expected", driver, extentedReport,
              true);
        else
          Log.fail("Latest position is not displaying unexpectedly", driver, extentedReport, true);

      } else {
        Log.fail("Failed - NB Policy Created in " + policyDetails.get("Status").toString()
            + " status, Policy status is not displayed as Accepted and displaying as "
  ...
  @Test(description = "To check the Edit or Accept a single saved Renewal Quote(NA)",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_391_392(String browser) throws Exception {

    // Get the web driver instance
    String tcId = "TC_391_392";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        BuyQuotePage buyQuotePage = new BuyQuotePage(driver, extentedReport);
        buyQuotePage.clicksave_LapsebuttoninAcceptancepage("Reviewed", "Save Renewal Quote", "Save",
            extentedReport);
        Log.softAssertThat(
            custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"),
                custdashboardpage),
        ...
        Log.softAssertThat(
            !(policyDetailsrnl.get("notification_plcy").toString().equalsIgnoreCase("L")),
            "Latest position is displaying", "Policy position is displaying as Lapsed", driver,
            extentedReport, true);
        ...
        Log.softAssertThat(
            ...
            true);
        // Verify the lapsed status of all the quotes
        policyDetailsrnl = custdashboardpage.getPolicyURN(extentedReport);
  ...
  @Test(
      description = "To check that the Manage Renewals tab is NOT displayed, if the policy is in a Expired status ",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_410_650(String browser) throws Exception {

    // Get the web driver instance
    String tcId = "TC_410_650";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      // Create New Quote
      custdashboardpage.clickNewQuote(true, extentedReport);
      custdashboardpage.enterNewQuotePastDate(0, 1, extentedReport, true);
      custdashboardpage.selectNewQuoteDetails(testData, extentedReport, false);
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        Log.softAssertThat(custdashboardpage.verifyExpiry(true, extentedReport),
            "Policy is not displayed as expired", "Policy is displayed as expired as expected");

        if (custdashboardpage.uielement
            .verifyPageElementsDoNotExist(Arrays.asList("drpManageRenewals"), custdashboardpage))
          Log.pass("Manage renewal tab is not dispalyed on customer dashaboard page as expected",
              driver, extentedReport, true);
        else
          Log.fail("Manage renewal tab is dispalying on customer dashboard page unexpectedly",
              driver, extentedReport, true);
  ...
  @Test(
      description = "To check that the user is allowed to edit the saved renewal quote with Lapsed status, onclicking on the quote variation in Manage quote variation tab ",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_387(String browser) throws Exception {
  ...
  @Test(
      description = "To check that the user is allowed to lapse the saved renewal quote with the Review Required status, using Lapse Quote option from Manage Renewals dropdown",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_388(String browser) throws Exception {
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        Log.softAssertThat(
            policyDetailsrnl.get("notification_plcy").toString().equalsIgnoreCase("L"),
            "Policy notification is displaying as Lapsed", "Latest position is not displaying");

        Log.softAssertThat(policyDetailsrnl.get("Status").toString().equalsIgnoreCase("Accepted"),
            "Policy status is displaying as accepted", "Policy status not displaying as accepted");

        if (policyDetailsrnl.get("Position").toString().equalsIgnoreCase("NewBusiness"))
          Log.pass(
              "Able to lapse the saved renewal quote with the Review Required status as expected",
              driver, extentedReport, true);
        else
          Log.fail("Expected Policy position is not displayed", driver, extentedReport, true);
  ...
  @Test(
      description = "To check that the user is allowed to lapse the saved renewal quote with the Reviewed status, using Lapse Quote option from Manage Renewals dropdown",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_390(String browser) throws Exception {
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        if (policyDetailsrnl.get("Position").toString().equalsIgnoreCase("NewBusiness"))
          Log.pass("Able to lapse the saved renewal quote with the Reviewed status as expected",
              driver, extentedReport, true);
        else
          Log.fail("Expected Policy position is not displayed", driver, extentedReport, true);
  ...
  @Test(
      description = "To check that the user is able to perform MTA for the policy which is in the renewal cycle ",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_393(String browser) throws Exception {
    String tcId = "TC_393";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      for (int i = 1; i < coversToAdd.length; i++) {
        ...
        String[] coverType = coversToAdd[i].split("_");
        if (BoolVal != false) {
          Log.message(coverType[2] + " " + coverType[0] + " cover done successfully", driver,
              extentedReport, true);
        } else {
          Log.fail("Failed to " + coverType[2] + " " + coverType[0] + " cover", driver,
              extentedReport, true);
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        Log.pass(
            "The user is able to perform MTA for the policy successfully which is in the renewal cycle",
            driver, extentedReport, true);
      } else {
        Log.fail(
            "Failed - The user is unable to perform MTA for the policy which is in the renewal cycle "
                + policyDetails.get("Status").toString() + " status",
            driver, extentedReport, true);
      }
  ...
  @Test(
      description = "User should be allowed to perform MTA against the latest active policy position",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_394(String browser) throws Exception {
    String tcId = "TC_394";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")
          && custdashboardpage.verifyActiveTransactions(extentedReport)) {
        Log.pass("User is allowed to perform MTA against the latest active policy position", driver,
            extentedReport, true);
      } else {
        Log.fail(
            "Failed - User isnot allowed to perform MTA against the latest active policy position"
                + policyDetails.get("Status").toString() + " status",
            driver, extentedReport, true);
      }
  ...
  @Test(
      description = "To check that user is not allowed to perform MTA against the policy in quoted renewal position",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_395(String browser) throws Exception {
    String tcId = "TC_395";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        ...
        Log.softAssertThat(
            policyDetailsrnl.get("notification_plcy").toString().equalsIgnoreCase("R"),
            "Renewal Policy position is displaying as Save",
            "Latest position is not displaying as expected");
      }
      ...
      Log.softAssertThat(
          custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"),
              custdashboardpage),
          "Navigated to custdashboardpage successfully after MTA",
          "Failed to Navigate to custdashboardpage after MTA", driver, extentedReport, true);

      if (policyDetails.get("Status").toString().equalsIgnoreCase("Accepted")) {
        Log.pass(
            "user is not allowed to perform MTA as expected against the policy in quoted renewal position",
            driver, extentedReport, true);
      } else {
        Log.fail(
            "Failed - user is allowed to perform MTA against the policy in quoted renewal position"
                + policyDetails.get("Status").toString() + " status",
            driver, extentedReport, true);
      }
  ...
  @Test(
      description = "To check that the policy is automatically re-invited upon completion and payment of the MTA ",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_396(String browser) throws Exception {
    String tcId = "TC_396";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      if (!(custdashboardpage.uielement.verifyPageElements(Arrays.asList("drpManageRenewals"),
          custdashboardpage))) {
        Log.pass(
            "The policy is automatically re-invited as expected upon completion and payment of the MTA ",
            driver, extentedReport, true);
      } else {
        Log.fail("Failed - The policy is not re-invited upon completion and payment of the MTA"
  ...
  // @Test(description = "To check that the renewal is re-invited based on the
  // data entered in the MTA", dataProviderClass = DataProviderUtils.class,
  // dataProvider = "ssBVTDataProvider")
  public void TC_397(String browser) throws Exception {
    String tcId = "TC_397";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
  ...
  @Test(
      description = "The user should be taken to the Data Capture screens where the data from the MTA has been pre-populated and the new inception date populated and protected upon",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_398(String browser) throws Exception {
    String tcId = "TC_398";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
    ...
    try {
      ...
      if (NewQuotePage.verifyAdjustmentDate(strDate, extentedReport)) {
        Log.pass(
            "MTA inception & End dates are populated correctly and disabled for editing as expected",
            driver, extentedReport, true);
      } else {
        Log.fail("Failed - MTA inception & End date are not populated correctly "
            + policyDetails.get("Status").toString() + " status", driver, extentedReport, true);
      }
  ...
  @Test(
      description = "To check that the user is allowed to edit the saved renewal quote with the 'Review Required status, onclicking on the quote variation in 'Manage quote variation' tab ",
      dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider")
  public void TC_386(String browser) throws Exception {
    String tcId = "TC_386";
    final WebDriver driver = WebDriverFactory.get(browser);
    HashMap<String, String> testData = getTestData(tcId);
