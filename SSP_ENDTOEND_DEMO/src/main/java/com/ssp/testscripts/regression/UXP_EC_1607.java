...
import com.ssp.pages.uxp.CardDetailsPage;
...
public class UXP_EC_1607 extends BaseTest {
	...
	public void TC_220(String browser) throws Exception {
		...
		try {
			...
			NewQuotePage.clickReCalculate(extentedReport);
			NewQuotePage.clickBuy(extentedReport);
			NewQuotePage.selectAvalilableAdjReasons("Add Cover", extentedReport, false);
			NewQuotePage.clickAddMTA(extentedReport, false);
			NewQuotePage.clickAddAllMTANextButton(extentedReport, true);
			NewQuotePage.clickSaveQuoteButton(extentedReport, true);		
			NewQuotePage.clickConfirmMTA(extentedReport);
			custdashboardpage.clickManagePolicy(extentedReport);
	...
	public void TC_221(String browser) throws Exception {
		...
		try {
			...
			NewQuotePage.clickBuy(extentedReport);
			NewQuotePage.selectAvalilableAdjReasons("Remove Cover", extentedReport, false);
			NewQuotePage.clickAddMTA(extentedReport, false);
			NewQuotePage.clickAddAllMTANextButton(extentedReport, true);
			NewQuotePage.clickConfirmMTA(extentedReport);
			custdashboardpage.clickManagePolicy(extentedReport);
	...
	public void BS_008_009_003(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
				...
				Log.pass("Entered Quote Details and Clicked on Confirm", driver, extentedReport, true);
				NewQuotePage NewQuotePage1 = new NewQuotePage(driver, extentedReport);
				NewQuotePage1.verifyNewQuotePage(false, extentedReport);
				Log.pass("Get quote page loaded successfully", driver, extentedReport, true);
				String[] coversToAdd = testData.get("coverToSelect_NB").toString().split(",");
				for (int i = 0; i < coversToAdd.length; i++) {
					boolean BoolVal =false;
					String ins_RowtoInteract = NewQuotePage1.SelectInsuranceItem(coversToAdd[i], true, extentedReport);
					BoolVal = NewQuotePage1.enterInsCoverDetails(testData, coversToAdd[i], ins_RowtoInteract, true,
							extentedReport);
					String[] coverType = coversToAdd[i].split("_");
				if (BoolVal != false) 
				{
				...
				NewQuotePage NewQuotePage11 = new NewQuotePage(driver, extentedReport);
				NewQuotePage11.clickReCalculate(extentedReport);
				NewQuotePage11.clickBuy(extentedReport);
				NewQuotePage11.selectAvalilableAdjReasons("Add Cover", extentedReport, false);
				NewQuotePage11.clickAddMTA(extentedReport, false);
				NewQuotePage11.clickAddAllMTANextButton(extentedReport, true);
				NewQuotePage11.takePayment(extentedReport);
				carddetailspage = NewQuotePage11.selectVisacard(extentedReport);
				carddetailspage.enterCardNumber(testData, extentedReport, true);
				carddetailspage.selectExpiry(testData, extentedReport, true);
				carddetailspage.enterVerification(extentedReport, true);
				carddetailspage.enterName(testData, extentedReport, true);
				carddetailspage.clickbuy(extentedReport, true);
				Log.message("Entered Card Details and Navigated to Verificaion page", driver, extentedReport, true);
				NewQuotePage11 = carddetailspage.clickContinueButton_getQuote(extentedReport);
				Log.softAssertThat(NewQuotePage11.verifyPaymentTrasaction(extentedReport), "Payment is successful",
						"Payment is not successful", driver, extentedReport, true);
				custdashboardpage = NewQuotePage.confirmPaymentOnMTA("MTA", testData, extentedReport);
				Log.softAssertThat(
						custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage),
	...
	public void BS_004(String browser) throws Exception {
		...
		carddetailspage1 = NewQuotePage11.selectVisacard(extentedReport);
		...
		Log.message("Entered Card Details and Navigated to Verificaion page", driver, extentedReport, true);
		NewQuotePage11 = carddetailspage1.clickContinueButton_getQuote(extentedReport);
		Log.softAssertThat(NewQuotePage11.verifyPaymentTrasaction(extentedReport), "Payment is successful",
				"Payment is not successful", driver, extentedReport, true);
		//newquotepage = NewQuotePage11.confirmPaymentOnMTA("MTA", testData, extentedReport);
		Log.softAssertThat(
		...
		for (int i = 0; i < coversToRemove.length; i++) {
			...
			isSuccessful = NewQuotePage.enterInsCoverDetails(testData, coversToRemove[i], ins_RowtoInteract, true,
					extentedReport);
	...
	public void BS_005(String browser) throws Exception {
		...
		Log.pass("Entered Quote Details and Clicked on Confirm", driver, extentedReport, true);
		NewQuotePage NewQuotePage2 = new NewQuotePage(driver, extentedReport);
		NewQuotePage2.verifyNewQuotePage(false, extentedReport);
		Log.pass("Get quote page loaded successfully", driver, extentedReport, true);
		String[] coversToAdd1 = testData.get("coverToSelect_MT").toString().split(",");
		for (int i = 0; i < coversToAdd1.length; i++) {
			boolean BoolVal =false;
			String ins_RowtoInteract = NewQuotePage2.SelectInsuranceItem(coversToAdd1[i], true, extentedReport);
			BoolVal = NewQuotePage2.enterInsCoverDetails(testData, coversToAdd1[i], ins_RowtoInteract, true,
					extentedReport);
		...
		NewQuotePage NewQuotePage3 = new NewQuotePage(driver, extentedReport);
		NewQuotePage3.clickReCalculate(extentedReport);
		NewQuotePage3.clickSavedButton(extentedReport);
		Log.softAssertThat(
				custdashboardpage1.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage1),
				"Navigated to Customer dashboard page", "Not navigated to Customer dashboard page", driver,
				extentedReport, true);		
		...
		NewQuotePage11.clickConfirmMTA(extentedReport);
		Log.softAssertThat(
				custdashboardpage1.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage1),
				"Navigated to Customer dashboard page", "Not navigated to Customer dashboard page", driver,
				extentedReport, true);
	...
	public void BS_001(String browser) throws Exception {
		...
		try {
			...
			Log.softAssertThat(
				...
				Log.softAssertThat(NewQuotePage.verifyPaymentTrasaction(extentedReport), "Payment is successful",
						"Payment is not successful", driver, extentedReport, true);
				//newquotepage = NewQuotePage.confirmPaymentOnMTA("MTA", testData, extentedReport);
				Log.softAssertThat(
						custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage),
						"Navigated to Customer dashboard page", "Not navigated to Customer dashboard page", driver,
						extentedReport, true);
				...
				NewQuotePage NewQuotePage2 = new NewQuotePage(driver, extentedReport);
				NewQuotePage2.clickReCalculate(extentedReport);
				NewQuotePage2.clickBuy(extentedReport);
				NewQuotePage2.selectAvalilableAdjReasons("Add Cover", extentedReport, false);
				NewQuotePage2.clickAddMTA(extentedReport, false);
				NewQuotePage2.clickAddAllMTANextButton(extentedReport, true);
				NewQuotePage2.takePayment(extentedReport);
				carddetailspage = NewQuotePage2.selectVisacard(extentedReport);
				carddetailspage.enterCardNumber(testData, extentedReport, true);
				carddetailspage.selectExpiry(testData, extentedReport, true);
				carddetailspage.enterVerification(extentedReport, true);
				carddetailspage.enterName(testData, extentedReport, true);
				carddetailspage.clickbuy(extentedReport, true);
				Log.message("Entered Card Details and Navigated to Verificaion page", driver, extentedReport, true);
				NewQuotePage2 = carddetailspage.clickContinueButton_getQuote(extentedReport);
				Log.softAssertThat(NewQuotePage2.verifyPaymentTrasaction(extentedReport), "Payment is successful",
						"Payment is not successful", driver, extentedReport, true);
				//newquotepage = NewQuotePage2.confirmPaymentOnMTA("MTA", testData, extentedReport);
				Log.softAssertThat(
						custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage),
						"Navigated to Customer dashboard page", "Not navigated to Customer dashboard page", driver,
						extentedReport, true);
				...
				custdashboardpage.enterMTADetails(testData, extentedReport, true);
				Log.pass("Entered Quote Details and Clicked on Confirm", driver, extentedReport, true);
				NewQuotePage NewQuotePage4 = new NewQuotePage(driver, extentedReport);
				NewQuotePage4.verifyNewQuotePage(false, extentedReport);
				Log.pass("Get quote page loaded successfully", driver, extentedReport, true);
				NewQuotePage NewQuotePage3 = new NewQuotePage(driver, extentedReport);
				NewQuotePage3.clickReCalculate(extentedReport);
				NewQuotePage3.clickBuy(extentedReport);
				NewQuotePage3.selectAvalilableAdjReasons("Add Cover", extentedReport, false);
				NewQuotePage3.clickAddMTA(extentedReport, false);
				NewQuotePage3.clickAddAllMTANextButton(extentedReport, true);
				NewQuotePage3.takePayment(extentedReport);
				carddetailspage = NewQuotePage3.selectVisacard(extentedReport);
				carddetailspage.enterCardNumber(testData, extentedReport, true);
				carddetailspage.selectExpiry(testData, extentedReport, true);
				carddetailspage.enterVerification(extentedReport, true);
				carddetailspage.enterName(testData, extentedReport, true);
				carddetailspage.clickbuy(extentedReport, true);
				Log.message("Entered Card Details and Navigated to Verificaion page", driver, extentedReport, true);
				NewQuotePage3 = carddetailspage.clickContinueButton_getQuote(extentedReport);
				Log.softAssertThat(NewQuotePage3.verifyPaymentTrasaction(extentedReport), "Payment is successful",
						"Payment is not successful", driver, extentedReport, true);
				//newquotepage = NewQuotePage3.confirmPaymentOnMTA("MTA", testData, extentedReport);
				Log.softAssertThat(
						custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage),
						"Navigated to Customer dashboard page", "Not navigated to Customer dashboard page", driver,
						extentedReport, true);
				...
				for (int i = 0; i < coversToAdd1.length; i++) {
					boolean BoolVal =false;
					String ins_RowtoInteract = NewQuotePage.SelectInsuranceItem(coversToAdd1[i], true, extentedReport);
					BoolVal = NewQuotePage.enterInsCoverDetails(testData, coversToAdd1[i], ins_RowtoInteract, true,
							extentedReport);
					String[] coverType = coversToAdd1[i].split("_");
				if (BoolVal != false) 
				{
				...
				NewQuotePage NewQuotePage5 = new NewQuotePage(driver, extentedReport);
				NewQuotePage5.clickReCalculate(extentedReport);
				NewQuotePage5.clickBuy(extentedReport);
				NewQuotePage5.selectAvalilableAdjReasons("Add Cover", extentedReport, false);
				NewQuotePage5.clickAddMTA(extentedReport, false);
				NewQuotePage5.clickAddAllMTANextButton(extentedReport, true);
				NewQuotePage5.takePayment(extentedReport);
				carddetailspage = NewQuotePage5.selectVisacard(extentedReport);
				carddetailspage.enterCardNumber(testData, extentedReport, true);
				carddetailspage.selectExpiry(testData, extentedReport, true);
				carddetailspage.enterVerification(extentedReport, true);
				carddetailspage.enterName(testData, extentedReport, true);
				carddetailspage.clickbuy(extentedReport, true);
				Log.message("Entered Card Details and Navigated to Verificaion page", driver, extentedReport, true);
				NewQuotePage5 = carddetailspage.clickContinueButton_getQuote(extentedReport);
				Log.softAssertThat(NewQuotePage5.verifyPaymentTrasaction(extentedReport), "Payment is successful",
						"Payment is not successful", driver, extentedReport, true);
			//	newquotepage = NewQuotePage5.confirmPaymentOnMTA("MTA", testData, extentedReport);
				Log.softAssertThat(
						custdashboardpage.uielement.verifyPageElements(Arrays.asList("lnkEditDetails"), custdashboardpage),
						"Navigated to Customer dashboard page", "Not navigated to Customer dashboard page", driver,
						extentedReport, true);
