...
public class WebDriverFactory {
	...
	public static int maxPageLoadWait = WaitUtils.maxElementWait;
...
//			hubURL = new URL("https://pavithrasubraman2:pxnvfFsRyAsec3pBg5gn@hub-cloud.browserstack.com/wd/hub");
		}
		...
		try {
			if ("chrome".equalsIgnoreCase(browser)) {
				...
				driver = new RemoteWebDriver(hubURL, chromeCapabilities);
			      ...
			      driver = new RemoteWebDriver(new URL("https://pavithrasubraman2:pxnvfFsRyAsec3pBg5gn@hub-cloud.browserstack.com/wd/hub"), caps);  
			 */
			  }
...
//					  String BS_resolution = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("res");
//				      System.out.println("Browser Details :" +BS_browser+ "," +BS_browserVersion + "," + BS_osVersion);
					  caps.setCapability("browser", BS_browser);
				      caps.setCapability("browser_version", BS_browserVersion);			      			      
//				      caps.setCapability("resolution", BS_resolution);
...
//					firefoxCapabilities.setCapability("browserName", "hrome");
//					firefoxCapabilities.setCapability("browser_version", "50.0");
					firefoxCapabilities.setCapability("browserstack.local", "true");
//					chromeCapabilities.setCapability("browserstack.localIdentifier", "Test123");
