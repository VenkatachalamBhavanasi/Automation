...
public class CustDashboardPage extends LoadableComponent<CustDashboardPage> {
  ...
  public com.ssp.support.ElementLayer uielement;
  ...
  // public String docviewbuttoncounter =
  // "div>div>div>a.btn.btn-default.page-spinner:not([title='Find Address'])";
  public String docviewbuttoncounter = "a[id^=C2__C6__BUT_BD388A52554BC5E73641765_R]";
  public String Confirmbtn = "button[id*='99ADFDA008E513D23844180']";
  public String rad_cancel = "#C2__C6__ITM_32BF5DA7372009F11482910";
  public String rad_Reinstate = "#C2__C6__MenuReinstatement";
  ...
  public String cssTransactionstatus = "[headers='C2__C6__p1_QUE_19504DF73EA7BBF571887']";
  public String cssTransactionPosition = "[headers='C2__C6__p1_QUE_19504DF73EA7BBF571884']";
  public String cssTransactionTax = "[headers='C2__C6__p1_QUE_19504DF73EA7BBF571905']";
  public String cssTransactionPayable = "[headers='C2__C6__p1_QUE_19504DF73EA7BBF571896']";
  public String cssTransactionPremium = "[headers='C2__C6__p1_QUE_19504DF73EA7BBF571899']";
  ...
  public String cssStaReason = "select[name*='STA[1].ADJUSTMENTREASON']";
  public String cssMtaReason = "select[name*='MTA[1].ADJUSTMENTREASON']";
  ...
  @FindBy(css = "#C2__C6__p1_GRP_4E9E6DEC4AB0C369160940")
  WebElement STAPrompt;
  ...
  @FindBy(css = "#a_viewPolicy")
  WebElement drpDwn_PolDetails;

  @FindBy(css = "div#C2__C6__p1_GRP_24F4D09ABF5D5E60316276")
  WebElement PolDetailsBar;
  ...
  @FindBy(css = "h2.page-title.custname")
  ...
  @FindBy(css = "#li_C2__C6__ITM_32BF5DA7372009F11482915")
  ...
  @FindBy(
      css = "div[id*='FMT_4C0E65162F00EDD9931673'] div.col-md-6.text-bold.text-right.panel-title")
  WebElement policyStatusExpire;

  @FindBy(css = "#C2__C6__MenuCancelCoolingOff")
  WebElement coolingOff;

  @FindBy(css = "button[id*='DB4A6646C4C5D63933610']")
  WebElement completeButon;

  @FindBy(css = "#C2__C1__BUT_ACC55707320688F0167556_R1")
  WebElement btnManagePolicyAddressEdit;

  // @FindBy(css = "span[id*='QUE_BD388A52554BC5E72766692']")
  // @FindBy(css = "span[id*='QUE_BD388A52554BC5E72766692']")
  @FindBy(css = "span[id*='C2__C6__QUE_BD388A52554BC5E72766692']")
  WebElement documentdescription;

  @FindBy(css = "span[id*='C2__C6__QUE_BD388A52554BC5E72766692']")
  List<WebElement> listOfDocumentDescription;
  ...
  @FindBy(css = "div[id*='4E9E6DEC4AB0C369160940']")
  WebElement STAPopUp;
  ...
  @FindBy(css = ".panel-title #accordian_collapseFour")
  ...
  @FindBy(css = "#C2__C6__MenuViewComplaints")
  ...
  @FindBy(css = "#C2__C6__ITM_97C78E9B190E52CA833600")
  WebElement dropdwn_polCover;

  @FindBy(css = "div#C2__C6__C1__p1_TBL_86346BDD86A498D8279031>div>table>tbody>tr>td:nth-child(")
  WebElement btn_view_in_polCover;
  ...
  @FindBy(css = "#C2__C1__COL_E3C198C90C6E246837179")
  ...
  // a[data-toggle='dropdown'][aria-expanded='false'],.nav.navbar-nav
  // :nth-child(3) a[data-toggle='dropdown']")
  ...
  @FindBy(css = "#date-picker-C2__C6__QUE_4E9E6DEC4AB0C369160965")
  WebElement date_StaExprydate;

  @FindBy(css = "#C2__C6__QUE_4E9E6DEC4AB0C369160962")
  WebElement time_StaEffctv;

  @FindBy(css = "#C2__C6__QUE_4E9E6DEC4AB0C369160968")
  WebElement time_StaExpry;

  @FindBy(css = "#a_viewTermsAndConditions")
  WebElement dropdownViewTandC;

  @FindBy(css = "#C2__C6__Menu_SuspendBilling")
  ...
  @FindBy(css = "#C2__C6__MenuManageRenewals")
  ...
  // @FindBy(css = "a[class*='newcomplaint.page-spinner']")
  @FindBy(css = "a[class*='newcomplaint'][class*='page-spinner']")
  ...
  @FindBy(
      css = "#C2__C4__TBL_3B87415692E0F10617428 tbody tr:nth-child(1) td:nth-child(10)>div:nth-child(1) div>span:nth-child(1) span")
  ...
  @FindBy(css = "#C2__C6__MenuManageRenewals > ul >li")
  List<WebElement> lstOptionInManageRenewals;

  @FindBy(css = "li.dropdown.renewal-quote.drop-inline.dropdown-hover.open > ul")
  List<WebElement> lstVariationInQuoteVariations;

  @FindBy(css = "div[class='container-fluid policy_drpdwn'] > ul> li")
  ...
  @FindBy(css = "#C2__C6__BUT_4E9E6DEC4AB0C369161217")
  WebElement btnStaCacnel;

  @FindBy(css = "#C2__C6__p1_GRP_4E9E6DEC4AB0C369160940 [id='closeModal']")
  WebElement btnStaClose;

  @FindBy(css = "button[id*='BUT_4F6C7E1EA3A0DE0E1111415']")
  WebElement btnMtaCacnel;

  @FindBy(css = "a#C2__C6__FMT_7521276D4111CE32862029")
  WebElement btnMtaClose;

  @FindBy(css = "#C2__C6__p4_QUE_726A765E51D907DB261850>div>div")
  WebElement InterestedPartycust;

  @FindBy(css = "button#C2__C6__takepayment")
  WebElement Financetakepayment;

  @FindBy(css = "#C2__C6__QUE_607B3301F22BCB87621342")
  WebElement TransactionIdInFinanceTab;

  @FindBy(css = "button#C2__C6__BUT_607B3301F22BCB87621556")
  WebElement FinancetakepaymentSave;

  @FindBy(xpath = "//div[@id='C2__TXT_C65051C7ED7E9644419119']//img")
  WebElement custDashStatus;
  ...
  public boolean verifyContactAddressDetails(String address) throws Exception {
    try {
      ...
      boolean status = false;
      String fullAddress = Utils.getTextOfWebElement(sectionContactDetails, driver);
      if (fullAddress.replace(" ", "").contains(address.replace(" ", ""))) {
        status = true;
      }
      return status;
    } catch (Exception e) {
  ...
  public boolean checkCustomerDashBoardStatus(boolean Screenshot, ExtentTest extentReport,
      String expectedResult) throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, custDashStatus,
          "Status is not present in customer dashboard page");
      System.out.println(custDashStatus.getAttribute("title"));
      if (custDashStatus.getAttribute("title").equalsIgnoreCase(expectedResult))
        return true;
    } catch (Exception e) {
      throw new Exception("Status is not present in customer dashboard page " + e);
    }
    return false;
  }
  ...
  public void clickManagePolicy(ExtentTest extentedReport) throws Exception {
    ...
    try {
      ...
      Utils.scrollIntoView(driver, drpManagePolicy);
      WaitUtils.waitForelementToBeClickable(driver, drpManagePolicy,
          "Manage dropdown not clickable after wait");
      ...
      try {
        ...
        if (e.getMessage().contains("not clickable")) {
          ...
          throw new Exception("Error in Clicking Manage Policy dropdown: " + e);

        if (status)
          Log.message("Clicked on Manage policy tab through JS");
      } catch (Exception ee) {
        throw new Exception("Error in Clicking Manage Policy dropdown : " + ee);
      }
    }
  }
  ...
  public void clickMidTermAdjustment(ExtentTest extentedReport) throws Exception {
    try {
      ...
      WaitUtils.waitForelementToBeClickable(driver, lnkMidTermAdjust,
          "Mid term adjustment option is not clickable");
      ((JavascriptExecutor) driver).executeScript("arguments[0].click();", lnkMidTermAdjust);
  ...
  public void clickShortTermAdjustment(ExtentTest extentedReport) throws Exception {
    try {
      WaitUtils.waitForelementToBeClickable(driver, shortTermAdj,
          "Short term adjustment option is not clickable");
      // shortTermAdj.click();
      ((JavascriptExecutor) driver).executeScript("arguments[0].click();", shortTermAdj);
      // Thread.sleep(2000);
      WaitUtils.waitForElement(driver, STAPrompt);
  ...
  public void EnterEffectiveDateOnWind(WebElement ElementToInteract, boolean Screenshot,
      String inceptionDate) throws Exception {
    try {

      Calendar calobj = Calendar.getInstance();
      SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
      Date date = format.parse(inceptionDate);
      calobj.setTime(date);
      // int month = calobj.get(Calendar.MONTH);
      // calobj.add(Calendar.MONTH, 1);
      calobj.add(Calendar.MONTH, 2);

      WaitUtils.waitForElementPresent(driver, 10, ElementToInteract,
  ...
  public void enterDateForMTA(ExtentTest extentedReport) throws Exception {
    try {
      ...
      txtMidTermDate.sendKeys(Keys.TAB);
      Thread.sleep(2000);
  ...
  public String enterfutureDateForMTA(ExtentTest extentedReport, boolean Screenshot)
    ...
    try {
      ...
      futureDate = Utils.setDate("future", txtMidTermDate, 2, 0);
  ...
  public void selectMidTermAdjReason(String MTAcreationReason, ExtentTest extentedReport)
    ...
    try {
      ...
      throw new Exception("Adjustment reason is not entered : " + e);
    }
  }
  ...
  public boolean verifyMTATransactionStatus() throws Exception {
    if (Utils.verifyListInAlphabeticalOrder(textMTAPosition)) {
      return false;
    }
    return true;
  }
  ...
  public boolean verifyMTATStatusAndDate(String MTAstatus) throws Exception {
    boolean status = false;
    if (Utils.verifyMatchingTextContainsElementFromList(txtMTAStatus, MTAstatus))
      status = true;
    return status;
  ...
  public void selectReverseTransType(String reason, ExtentTest extentedReport, boolean screenshot)
      throws Exception {
    try {
      Utils.getMatchingTextElementFromList(optReverseTransactionType, reason).click();
  ...
  public void enterQuoteDetails(HashMap<String, String> testdata, boolean Screenshot,
    ...
    try {
      ...
      String strDate = Utils.setDate("current", datePicker, 0, 0);
      datePicker.click();
  ...
  public void selectIntermediary(String intermediary, ExtentTest extentReport) throws Exception {
    try {
      ...
      Log.message("Intermediary Selected: " + intermediary, driver, extentReport, true);
    } catch (Exception e) {
  ...
  public void clickCancelPolicy(ExtentTest extentedReport) throws Exception {
    ...
    try {
      ...
      try {
        ...
        if (e.getMessage().contains("not clickable")) {
          WaitUtils.waitForElement(driver, drpCancelPolicy);
          ((JavascriptExecutor) driver).executeScript("arguments[0].click();", drpCancelPolicy);
          status = true;
        } else
          throw new Exception("Error in Clicking Cancel Policy tab: " + e);

        if (status)
          Log.message("Clicked on Cancel policy tab through JS");
      } catch (Exception ee) {
        throw new Exception("Unable to click on Cancel Policy tab :" + ee);
      }
    }
  ...
  public void clickCancelPolicy(HashMap<String, String> testdata, boolean screenshot,
      ExtentTest extentedReport) throws Exception {
    Utils.scrollIntoView(driver, driver.findElement(By.cssSelector(rad_cancel)));
    ...
    try {
      ...
      if (testdata.get("Cancellation type").equals("Standard Cancellation")) {
        WaitUtils.waitForElement(driver, standardCancellation);
        ...
        WaitUtils.waitForSpinner(driver);
        WaitUtils.waitForElement(driver, coolingOff, 10);
        coolingOff.click();
        WaitUtils.waitForSpinner(driver);
  ...
  public void enterReason(String CancelReason, ExtentTest extentedReport) throws Exception {
    try {
      ...
      WaitUtils.waitForElement(driver, cancelReason);
      WaitUtils.waitForelementToBeClickable(driver, cancelReason,
          "dropdown to select property type is not clickable");
      Select dropdown = new Select(cancelReason);
      List<WebElement> lists = dropdown.getOptions();

      for (int i = 0; i < lists.size(); i++) {
        if (lists.get(i).getText().contains(CancelReason)) {
          lists.get(i).click();
          Log.message(CancelReason + " - Cancel Reason Option is selected", driver, extentedReport,
              true);
          break;
        }
      }
  ...
  public boolean verifyCancellation(boolean screenshot, ExtentTest extentedReport)
    ...
    try {
      ...
      if (policyStatusCancelled.getText().toString().equalsIgnoreCase("Cancelled")) {
    ...
    try {
      ...
      (new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS)
          ...
          .withMessage("Reinstate Policy is not clickable"))
              .until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(rad_Reinstate)));
      selectRadioButton(rad_Reinstate, "Reinstate Policy");
  ...
  public void selectReinstateReason(HashMap<String, String> testdata, boolean screenshot,
    ...
    try {
      ...
      WaitUtils.waitForElement(driver, drpReinstateReason);
      Select dropdown = new Select(drpReinstateReason);
      List<WebElement> lists = dropdown.getOptions();

      Thread.sleep(500);

      for (int i = 0; i < lists.size(); i++) {
        if (lists.get(i).getText().contains(testdata.get("Reinstate Reason"))) {
          lists.get(i).click();
          Log.message(testdata.get("Reinstate Reason") + " - Reinstate Reason Option is selected",
  ...
  public void clickConfirmForReinstate(boolean screenshot, ExtentTest extentedReport)
    ...
    try {
      ...
      WaitUtils.waitForSpinner(driver);
      WaitUtils.waitForinvisiblityofElement(driver, 30, popup_Reinst,
  ...
  public boolean verifyReinstation(boolean screenshot, ExtentTest extentedReport) throws Exception {
    ...
    try {
      ...
      return Utils.verifyWebElementTextEquals(policyStatusReinstate, "ACTIVE");
   ...
   * 
   */
  public boolean verifyExpiry(boolean screenshot, ExtentTest extentedReport) throws Exception {

    try {
      return Utils.verifyWebElementTextEquals(policyStatusExpire, "EXPIRED");

    } catch (Exception e) {
      throw new Exception("Error while verifying expired policy:" + e);
    }
    ...
    try {
      ...
      try {
        ...
        if (e.getMessage().contains("not clickable")) {
          ...
          throw new Exception("Error in Clicking Button option: " + e);

      } catch (Exception ee) {
        throw new Exception("Unable to Select Button Option" + ee);
      }
   ...
   * 
   */
  public boolean clickdocViewbtn(String Policynum, String ECUrl, ExtentTest extentedReport)
      throws Exception {
    ...
    try {
      ...
      if (viewbuttonscount.size() > 0) {
        // viewbuttons =
        // driver.findElement(By.cssSelector(docviewFirst));
        ...
        String policyURLFormat =
            "/SIaaS/ServerFileRetrievalServlet?paramsSessionAttrName=DOC_PARAMS&guID=";
        if (act.contains(policyURLFormat)) {
   ...
   * 
   */
  public boolean VerifySTAfromManagePolicyTab(ExtentTest extentedReport, boolean Screenshot)
      throws Exception {
    try {
      clickTab("Manage Policy", extentedReport, true);
      // waitUtils.waitForElementPresent(driver, shortTermAdj, "");
      Log.message("STA does exist on manage policy sub menu", extentedReport);
      return shortTermAdj.isDisplayed();
    } catch (Exception e) {
      throw new Exception("Unable to see STA from Manage Policy" + e);
    }
  }
   ...
   * 
   */
  public boolean VerifySTAPrompt(ExtentTest extentedReport, boolean Screenshot) throws Exception {
    try {

      return STAPrompt.isDisplayed();
    } catch (Exception e) {
      throw new Exception("Unable to see STA prompt" + e);
    }
  }
   ...
   * 
   */
  public boolean VerifyFieldsSTAPrompt(ExtentTest extentedReport, boolean Screenshot)
      throws Exception {
    try {

      return date_StaEffctvdate.isDisplayed() && time_StaEffctv.isDisplayed()
          && date_StaExprydate.isDisplayed() && time_StaExpry.isDisplayed()
          && staReason.isDisplayed();
    } catch (Exception e) {
      throw new Exception("Unable to see expected fields in STA prompt" + e);
    }
  }
  ...
  public void clickfromManagePolicyDropdown(HashMap<String, String> testdata, boolean screenshot,
    ...
    WaitUtils.waitForElementPresent(driver, 10, PolicyAdminPane,
  ...
  public void click(WebElement elment, String msg) throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, 10, elment, "Failed to " + msg);
      elment.click();
      Log.event(msg);
    } catch (Exception e) {
   ...
   * 
   */
  public NewQuotePage enterMTADetails(HashMap<String, String> testdata, ExtentTest extentedReport,
      boolean Screenshot) throws Exception {
    try {
      ...
      Thread.sleep(1000);
      selectMTAReason(testdata.get("MTAdjReason"));
      Thread.sleep(1000);
  ...
  public NewQuotePage enterMTADetailsInPast(HashMap<String, String> testdata,
      ExtentTest extentedReport, boolean Screenshot, int noOfMonths) throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, 40, MTAPopUp,
          "MTA Reason selection window was not found");
      SimpleDateFormat formDate = new SimpleDateFormat("dd/MM/yyyy");
      ...
      new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS)
          .until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(mtaStartDate))));
      WebElement mtaStartDateele = driver.findElement(By.cssSelector(mtaStartDate));
      EnterEffectiveDateOnWindInPast(mtaStartDateele, true, noOfMonths);
      Thread.sleep(1000);
      selectMTAReason(testdata.get("MTAdjReason"));
      Thread.sleep(1000);
      click(mtaContinueBut, "Clicked continue button on MTA popup ");
  ...
  public void enterSTADetails(HashMap<String, String> testdata, ExtentTest extentedReport,
    ...
    try {
      ...
      enterSTADetailsInPopup(testdata, extentedReport, Screenshot);
      click(staContinueBut, "Clicked continue button on STA popup ");
      WaitUtils.waitForSpinner(driver);
      WaitUtils.waitForinvisiblityofElement(driver, 5, staStartDate,
          "STa popup did not close after 5sec");
  ...
  public void enterSTADetailsInPast(HashMap<String, String> testdata, ExtentTest extentedReport,
      boolean Screenshot) throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, 40, STAPopUp,
          "STA Reason selection window was not found");
      enterSTADetailsInPopupOfPast(testdata, extentedReport, Screenshot);
      click(staContinueBut, "Clicked continue button on STA popup ");
      WaitUtils.waitForSpinner(driver);
      WaitUtils.waitForinvisiblityofElement(driver, 5, staStartDate,
          "STa popup did not close after 5sec");
   ...
   * 
   */
  public void enterSTADetailsInPopup(HashMap<String, String> testdata, ExtentTest extentedReport,
      boolean Screenshot) throws Exception {
    /*
     * try {
     * 
     * String inception = testdata.get("InceptionDate"); String expiry = testdata.get("ExpiryDate");
     * 
     * SimpleDateFormat formDate = new SimpleDateFormat("dd/MM/yyyy"); String strDate =
     * formDate.format(new Date()); Log.event("Date is : " + strDate);
     * 
     * new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS)
     ...
     * EnterEffectiveDateOnWind(staStartDateEle, true, inception); Thread.sleep(1000);
     * 
     * new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS)
     ...
     * EnterExpiryDateOnWind(staExpiryDateEle, true, expiry); Thread.sleep(1000);
     * 
     * selectSTAReason(testdata.get("AdjustmentReason")); Thread.sleep(1000);
     */
    try {
      // String inception = testdata.get("InceptionDate");
      /* = testdata.get("ExpiryDate") */
      SimpleDateFormat formDate = new SimpleDateFormat("dd/MM/yyyy");
      String todayDate = formDate.format(new Date());
      String strDate = todayDate;
      String expiry = todayDate;
      Log.event("Date is : " + strDate);
      new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS)
          .until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(staStartDate))));
      WebElement staStartDateEle = driver.findElement(By.cssSelector(staStartDate));
      // EnterEffectiveDateOnWind(staStartDateEle, true, inception);
      EnterEffectiveDateOnWind(staStartDateEle, true, strDate);
      Thread.sleep(1000);
      new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS).until(
          ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(staExpiryDate))));
      WebElement staExpiryDateEle = driver.findElement(By.cssSelector(staExpiryDate));
      EnterExpiryDateOnWind(staExpiryDateEle, true, expiry);
      Thread.sleep(1000);
      selectSTAReason(testdata.get("AdjustmentReason"));
      Thread.sleep(1000);

    } catch (Exception e) {
      throw new Exception("Failed to enter STA details in popup: " + e);
    }
  }

  public void enterSTADetailsInPopupOfPast(HashMap<String, String> testdata,
      ExtentTest extentedReport, boolean Screenshot) throws Exception {
    try {
      String strDate = testdata.get("InceptionDate");
      Log.event("Date is : " + strDate);
      new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS)
          .until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(staStartDate))));
      WebElement staStartDateEle = driver.findElement(By.cssSelector(staStartDate));
      ...
      new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS).until(
          ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(staExpiryDate))));
      WebElement staExpiryDateEle = driver.findElement(By.cssSelector(staExpiryDate));
      EnterExpiryDateOnWind(staExpiryDateEle, true, strDate);
      Thread.sleep(1000);
      selectSTAReason(testdata.get("AdjustmentReason"));
      Thread.sleep(1000);
  ...
  public NewQuotePage verifyNewQuotePage(ExtentTest extentReport) throws Exception {
  ...
  public void EnterEffectiveDateOnWindInPast(WebElement ElementToInteract, boolean Screenshot,
      int noOfMonths) throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, 10, ElementToInteract,
          "Failed to click on MTA date field");
      SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
      Calendar calobj = Calendar.getInstance();
      calobj.add(Calendar.DAY_OF_MONTH, -noOfMonths);
  ...
  public HashMap<String, String> getPolicyURN(ExtentTest extentedReport) throws Exception {
    try {
      ...
      hmpolDetails.put("PolicyNo", Utils.getTextOfWebElement(tbl_Policydetails.get(2), driver));
      hmpolDetails.put("Position", Utils.getTextOfWebElement(tbl_Policydetails.get(0), driver));
      hmpolDetails.put("Status", Utils.getTextOfWebElement(tbl_Policydetails.get(1), driver));
      hmpolDetails.put("InceptionDate",
          Utils.getTextOfWebElement(tbl_Policydetails.get(3), driver));
      hmpolDetails.put("ExpiryDate", Utils.getTextOfWebElement(tbl_Policydetails.get(4), driver));
      hmpolDetails.put("Product", Utils.getTextOfWebElement(tbl_Policydetails.get(5), driver));
      hmpolDetails.put("Scheme", Utils.getTextOfWebElement(tbl_Policydetails.get(7), driver));
      hmpolDetails.put("notification_plcy",
          Utils.getTextOfWebElement(tbl_Policydetails.get(9), driver));
   ...
   * 
   * 
   *         public void clickComplete(ExtentTest extentedReport) throws Exception { try {
   *         waitUtils.waitForElementPresent(driver, 10, completeButon, "Failed to locate complete
   *         button"); ((JavascriptExecutor) driver).executeScript("arguments[0].click();",
   *         completeButon); waitUtils.waitForSpinner(driver); Log.message("Clicked on Complete
   *         button successfully", driver, extentedReport); } catch (Exception e) { throw new
   *         Exception("Unable to click complete button, throws exception :" + e); } }
   */
  ...
  public boolean verifyErPoostCodeNotEnteredEditAddress(String textToVerify,
    ...
    if (!Utils.verifyWebElementTextContains(txtEditAddressPostCodeErrMsg, textToVerify)) {
      return false;
    }
    return true;
  }
    ...
    try {
      ...
      switch (expCollapse) {
        ...
        case "Default_Collapse":
          ...
          try {
            WaitUtils.waitForElementPresent(driver, 10,
        ...
        case "Default_Expand":
          try {
            ...
            Utils.moveToElementJS(driver, ele_Tochk);
            ((JavascriptExecutor) driver).executeScript("arguments[0].click();", ele_Tochk);

            Log.message(ele_Tochk.getText() + " field in default expanded state", driver,
                extentedReport, true);
  ...
  public void verify_PolicyTab(String URN, ExtentTest extentedReport, boolean Screenshot)
    ...
    try {
      ...
      if (Utils.getTextOfWebElement(tab_PolicyHolder_details, driver).trim()
      ...
      WaitUtils.waitForinvisiblityofElement(driver, 10, tab_PolicyHolder + but_collapse,
          "Collpase buton was visible on policy bar, it should present on policy information bar");
      WaitUtils.waitForinvisiblityofElement(driver, 10, tab_PolicyHolder + but_expand,
  ...
  public void verifyPolDetailTab(ExtentTest extentedReport, boolean Screenshot) throws Exception {
    WaitUtils.waitForElementPresent(driver, 10, tab_viewPolDetails,
    ...
    try {
      ...
      for (int i = 0; i < buttonOptions.size(); i++) {
        if (buttonOptions.get(i).getText().contains("Policy Details")) {
          WaitUtils.waitForElementPresent(driver, 10, drpDwn_PolDetails,
              "Unable to locate policy details menu item");
          drpDwn_PolDetails.click();
          Log.message("Clicked on Policy Details", extentedReport);
          WaitUtils.waitForElementPresent(driver, 10, drpDwn_polCover,
  ...
  public WebElement getTabElement(String tabName, ExtentTest extentedReport, boolean Screenshot) {
    ...
    } else if (tabName.equalsIgnoreCase("Policy Details")) {
      tabElement = tab_viewPolDetails;
  ...
  public void validate_mousehover_tabs(ExtentTest extentedReport, boolean Screenshot)
    ...
    try {
      ...
      Utils.moveToElementJS(driver, tab_viewQuotPolicies);
  ...
  public void selectMenu_from_policyDetails_tab(String valToSelect, ExtentTest extentedReport,
    ...
    try {
      ...
      drpDwn_PolDetails.click();
      /*
       * List<WebElement> buttonOptions = driver.findElements(By.cssSelector(rad_cancel)); for (int
       * i = 0; i < buttonOptions.size(); i++) { if
       * (buttonOptions.get(i).getText().contains("Policy Details")) {
       * WaitUtils.waitForElementPresent(driver, 10, drpDwn_PolDetails,
       * "Unable to locate policy details menu item"); System.out.println("hi");
       * drpDwn_PolDetails.click(); Log.message("Clicked on Policy Details tab", driver,
       * extentedReport); break; } }
       */
      WaitUtils.waitForSpinner(driver);
      if (valToSelect.equalsIgnoreCase("Policy cover"))
        WaitUtils.waitForElementPresent(driver, 10, dropdwn_polCover,
  ...
  public boolean validate_PolicyDetailSection() throws Exception {
    WaitUtils.waitForElementPresent(driver, 10, fld_bldCover,
        "Unable to find the policy cover section");
    return Utils.verifyWebElementTextEqualsIgnoreCase(fld_bldCover, "Buildings cover");
  }
   ...
   * 
   */
  public boolean verifyContactName(String name) throws Exception {
    boolean status = false;
    String ContactName[] = txtContactName.getText().split("Date of Birth");
    if (ContactName[0].trim().equalsIgnoreCase(name)) {
  ...
  public void click_cust_compButton(ExtentTest extentedReport) throws Exception {
    ...
    WaitUtils.waitForElementPresent(driver, 20, btn_custComplete,
        "Unable to find the policy cover section");
    try {
   ...
   * 
   */
  public boolean verifyActiveTransactions(ExtentTest extentedReport) throws Exception {
    ...
    try {
      ...
      for (int loopcount = 0; loopcount < totalRowSize; loopcount++) {
        List<WebElement> lstTranscationRow =
            lstTransactionTable.get(loopcount).findElements(By.cssSelector("td"));
   ...
   * 
   */
  public void selectTransactionRow(ExtentTest extentedReport, String Status) throws Exception {
    ...
    try {
      ...
      for (int loopcount = 0; loopcount < totalRowSize; loopcount++) {
        ...
        for (int elementCount = 0; elementCount < TotalElement; elementCount++) {
          ...
          if (lstTranscationRow.get(elementCount).getText().equals(Status)) {
            Utils.scrollIntoView(driver, lstTranscationRow.get(elementCount));
  ...
  public NewQuotePage clickEditTransactionButton(ExtentTest extentedReport, boolean Screenshot)
      throws Exception {
    try {
      WaitUtils.waitForelementToBeClickable(driver, btnEditTransaction,
          "Unable to find the policy cover section");
      Utils.scrollIntoView(driver, btnEditTransaction);
  ...
  public boolean verifyPolicyholderName(String NameToVerify) throws Exception {
    try {
      return Utils.verifyWebElementTextContains(txtAreaPolicyHolder, NameToVerify);
    } catch (Exception e) {
  ...
  public boolean verifyPolicyholderSeparatedByComma() throws Exception {
    try {
      return Utils.verifyWebElementTextContains(txtAreaPolicyHolder, ",");
    } catch (Exception e) {
      throw new Exception("Error while veriying the bold font of the main policy holder" + e);
    }
  ...
  public boolean verifyMainPolicyholderDisplayedFirst(String substringToVerify) throws Exception {
    try {
      return Utils.verifyWebElementStartWith(driver, txtAreaPolicyHolder, substringToVerify);
    } catch (Exception e) {
      throw new Exception("Error while veriying the bold font of the main policy holder" + e);
    }
  ...
  public boolean verifyMainPolicyholderBoldFont() throws Exception {
    try {
      ...
      return Utils.verifyFont(driver, cssMainHolderPolicy, fontBold);
    } catch (Exception e) {
      throw new Exception("Error while veriying the bold font of the main policy holder" + e);
    }
  ...
  public NewQuotePage clickEditfromManagePolicyDropdown(ExtentTest extentedReport,
      boolean screenshot) throws Exception {
    try {
      ...
      for (int loopcount = 0; loopcount < totalRowSize; loopcount++) {
        ...
        for (int elementCount = 0; elementCount < TotalElement; elementCount++) {
          ...
          if (lstTranscationRow.get(elementCount).getText().equals("MidTermAdjustment")) {
            Utils.scrollIntoView(driver, btnEditTransaction); // scroll
                                                              // down
  ...
  public void enterRequestCancellationDetails(String type, String reason, ExtentTest extendedReport)
    ...
    try {
      ...
      drpCancelType.click();
      Utils.getMatchingTextElementFromList(drpoptCancelType, type).click();
  ...
  public boolean verifyMTAPremium(String premium) throws Exception {
    boolean status = false;
    if (Utils.verifyMatchingTextContainsElementFromList(txtMTAPremium, premium))
      status = true;
    return status;
  ...
  public boolean verifyAddedTandC_Collapsed(String policyToClick, ExtentTest extentedReport,
    ...
    try {
      ...
      boolean isCollapsed = (new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS)
          .ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
  ...
  public void performRenewals_LapseRenewal(String menuToClick, ExtentTest extentedReport,
    ...
    try {
      selectManageRenewals(extentedReport, true);
      selectInviteRenewals(menuToClick, extentedReport, true);
    } catch (Exception e) {
      throw new Exception("Unable to locate Manage renewals tab in customer dashboard page:" + e);
    }
  }

  public void selectManageRenewals(ExtentTest extentedReport, boolean screenshot) throws Exception {
    ...
    try {
      ...
      Utils.scrollIntoView(driver, drpManageRenewals);
      ...
      try {
        ...
        if (e.getMessage().contains("not clickable")) {
          ((JavascriptExecutor) driver).executeScript("arguments[0].click();", drpManageRenewals);
          status = true;
          WaitUtils.waitForSpinner(driver);
        } else
          throw new Exception("Error in Clicking Manage Renewals dropdown: " + e);

        if (status)
          Log.message("Clicked on Manage Renewals tab through JS");
      } catch (Exception ee) {
        throw new Exception("Error in Clicking Manage Renewals dropdown : " + ee);
      }
    }
  }

  public void selectInviteRenewals(String menuToClick, ExtentTest extentedReport,
      boolean screenshot) throws Exception {
    ...
    try {
      ...
      try {
        ...
        if (e.getMessage().contains("not clickable")) {
          ...
          WaitUtils.waitForElement(driver, eleToClick);
          ((JavascriptExecutor) driver).executeScript("arguments[0].click();", eleToClick);
          status = true;
        } else
          throw new Exception("Error in Clicking Manage Renewals dropdown option: " + e);

        if (status)
          Log.message("Clicked on Manage Renewals tab option through JS");
      } catch (Exception ee) {
        throw new Exception("Error in Clicking Manage Renewals option dropdown : " + ee);
      }
    }
  }
  ...
  public SuspendBillingPage selectSuspendBillingfromManagePolicy(ExtentTest extentedReport,
      boolean screenshot) throws Exception {
    try {
      Utils.scrollIntoView(driver, tab_manage_policy);
      tab_manage_policy.click();
      WaitUtils.waitForSpinner(driver);
      Log.message("Clicked on Manage Policy", extentedReport);
  ...
  public boolean verifySuspendBilling_Accepted() throws Exception {
    try {
      ...
      if (WaitUtils.waitForElement(driver, titleSuspendBilling)) {
        status = Utils.verifyWebElementTextContains(titleSuspendBilling, "Billing Suspended");
      }
      return status;
    } catch (Exception e) {
  ...
  public boolean verifyUnsuspendBilling_Accepted() throws Exception {
    try {
      if (WaitUtils.waitForElement(driver, titleUnsuspendBilling)) {
        Utils.scrollIntoView(driver, titleUnsuspendBilling);
        return Utils.verifyWebElementTextContains(titleUnsuspendBilling, " ACTIVE");
      } else {
  ...
  public boolean verifyPaymentMethod(String Paymentmethod) throws Exception {
    try {
      if (WaitUtils.waitForElement(driver, txtPayementCard)) {
        return Utils.verifyWebElementTextContains(txtPayementCard, Paymentmethod);
      } else {
  ...
  public boolean verifySystemAuditHistory(ExtentTest extentedReport, String[] message)
    ...
    try {
      ...
      Utils.scrollIntoView(driver, tab_system_Audit_History);
      tab_system_Audit_History.click();
      btnView1.click();
      Utils.scrollIntoView(driver, txtpaneSystemAudit);
  ...
  public BuyQuotePage performRenewals_QuoteVariation(ExtentTest extentedReport, boolean screenshot)
    ...
    try {
      selectRenewalsQuoteVariation(extentedReport, true);

      selectRenewalsQuoteVariationOption(extentedReport, true);
      WaitUtils.waitForSpinner(driver);
  ...
  public void selectRenewalsQuoteVariation(ExtentTest extentedReport, boolean screenshot)
      throws Exception {

    try {
      WaitUtils.waitForSpinner(driver);
      Utils.scrollIntoView(driver, drpRenewQotVariations);
      WaitUtils.waitForElement(driver, drpRenewQotVariations);

      drpRenewQotVariations.click();
      WaitUtils.waitForPageLoad(driver, 30);
      Log.message("Clicked on Renewal Quote Variations Tab", driver, extentedReport, screenshot);
      ...
      try {
        ...
        if (e.getMessage().contains("not clickable")) {
          ((JavascriptExecutor) driver).executeScript("arguments[0].click();",
              drpRenewQotVariations);
          WaitUtils.waitForPageLoad(driver, 30);
          status = true;
        } else
          throw new Exception("Error in Clicking Renewal Quote Variations Tab: " + e);

        if (status)
          Log.message("Clicked on Renewal Quote Variations Tab through JS");
      } catch (Exception ee) {
        throw new Exception("Error in Clicking Renewal Quote Variations Tab : " + ee);
      }
    }
  }

  public void selectRenewalsQuoteVariationOption(ExtentTest extentedReport, boolean screenshot)
      throws Exception {
    ...
    try {
      ...
      Thread.sleep(2000);
      WaitUtils.waitForSpinner(driver);
      Log.message("Clicked on " + drpoptRenewQotVariations, driver, extentedReport, screenshot);
      ...
      try {
        ...
        if (e.getMessage().contains("not clickable")) {
          ((JavascriptExecutor) driver).executeScript("arguments[0].click();",
              drpoptRenewQotVariations);
          status = true;
        } else
          throw new Exception("Error in Clicking Renewal Quote Variations dropdown option: " + e);

        if (status)
          Log.message("Clicked on Renewal Quote Variations tab option through JS");
      } catch (Exception ee) {
        throw new Exception(
            "Error in Clicking Renewal Quote Variations tab dropdown option : " + ee);
      }
    }
  }
  ...
  public HomePage clickCompleteButton() throws Exception {
    try {
      (new WebDriverWait(driver, 10).pollingEvery(250, TimeUnit.MILLISECONDS)
          .ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
  ...
  public boolean VerifyLapseRenewalModal(ExtentTest extentedReport, boolean screenshot)
    ...
    try {
      ...
      boolean boolmsg = Utils.verifyWebElementTextContains(msgWarningLapseQte,
  ...
  public boolean verifyPreferences(String btnToCheck, ExtentTest extentedReport, boolean screenshot)
    ...
    try {
      ...
      switch (btnToCheck.toLowerCase()) {
        ...
        // Verify the message
        case "post":
          WaitUtils.waitForElementPresent(driver, radPostpref,
  ...
  public String getPremiums(ExtentTest extentedReport, boolean screenshot) throws Exception {
    try {
      return Utils.getTextOfWebElement(txtPremiumAmt, driver);
    }
  ...
  public boolean verifyEditBusinesAddress(ExtentTest extentedReport, boolean screenshot)
    ...
    try {
      ...
      if (WaitUtils.waitForElement(driver, tabBusiAddress, 2)) {
        ...
        String OldAdd = Utils.getTextOfWebElement(eleTabs.get(0), driver);
        ...
        if (WaitUtils.waitForElement(driver, txtBusinsPostCode, 5)) {
          ...
          String NewAddress = Utils.getTextOfWebElement(txtAddress, driver);
          ...
          boolval = Utils.verifyWebElementTextEqualsIgnoreCase(txtAddressCustPage, NewAddress);
  ...
  public void clickManageRenewal(ExtentTest extentedReport, boolean screenshot) throws Exception {
    ...
    try {
      ...
      try {
        if (e.getMessage().contains("not clickable")) {
          WaitUtils.waitForElement(driver, drpManageRenewals, 2);
          ((JavascriptExecutor) driver).executeScript("arguments[0].click();", drpManageRenewals);
        }

        else
          throw new Exception("Unable to select Manage Renewals dropdown: " + e);

      } catch (Exception ee) {
        throw new Exception("Unable to select Manage Renewals dropdown : " + ee);
      }
    }
  }
  ...
  public boolean verifyOptionInManageRenewals(String menuToClick, ExtentTest extentedReport,
    ...
    try {
      ...
      for (int i = 0; i < lstOptionInManageRenewals.size(); i++) {
        if (lstOptionInManageRenewals.get(i).getText().equalsIgnoreCase(menuToClick)) {
          status = true;
  ...
  public boolean verifygyedoutOptionInManageRenewals(String menuToClick, ExtentTest extentedReport,
      boolean screenshot) throws Exception {
    boolean status = false;
    ...
    try {
      ...
      for (int i = 0; i < lstOptionInManageRenewals.size(); i++) {
        ...
        WebElement option = driver.findElement(By.cssSelector(
            "#C2__C6__MenuManageRenewals > ul >li" + ":nth-child(" + (i + 1) + ")>div"));

        System.out.println(option.getAttribute("class"));
        if (lstOptionInManageRenewals.get(i).getText().equalsIgnoreCase(menuToClick)
            && (option.getAttribute("class").equals("leaf-menu page-spinner disable_attr"))) {
          status = true;
          break;
        }
      }
        ...
        if (e.getMessage().contains("not clickable")) {
          for (int i = 0; i < lstOptionInManageRenewals.size(); i++) {
            if (lstOptionInManageRenewals.get(i).getText().equals(menuToClick)) {
              ((JavascriptExecutor) driver).executeScript("arguments[0].click();",
                  lstOptionInManageRenewals.get(i));
              status = true;
              break;
            }
          }
          ...
          throw new Exception("Error in Selecting Manage Renewals dropdown option: " + e);

        if (status)
          Log.message("Clicked on " + menuToClick + " from Manage Renewals");
      } catch (Exception ee) {
        throw new Exception("Error in Selecting Manage Renewals dropdown option : " + ee);
      }
    }
  }
  ...
  public boolean verifyOptionInRenewalQuoteVariations(String menuToClick, ExtentTest extentedReport,
    ...
    boolean status = false;
    try {
      for (int i = 0; i <= lstVariationInQuoteVariations.size() - 1; i++) {
        if (lstVariationInQuoteVariations.get(i).getText().contains(menuToClick)) {
          status = true;
          break;
        }
      }
    ...
    try {
      ...
      try {
        ...
        if (e.getMessage().contains("not clickable")) {
          ...
          throw new Exception("Error in Clicking Renewal Quote Variationss tab: " + e);

        if (status)
          Log.message("Clicked on Renewal Quote Variationss tab through JS");
      } catch (Exception ee) {
        throw new Exception(
    ...
    try {
      ...
      for (int i = 0; i < lstVariations.size(); i++) {
        if (lstVariations.get(i).getText().equalsIgnoreCase(variationName)) {
          ...
          action.moveToElement(lstVariations.get(i)).build().perform();
          action.click(lstVariations.get(i)).build().perform();
          WaitUtils.waitForSpinner(driver);
      ...
      if (!flag)
        throw new Exception("No options has been selected from Quote variation dropdown");
  ...
  public boolean verifyTabUnderPolicyHolder(String tabToCheck, ExtentTest extentedReport,
    ...
    boolean status = false;
    try {
      // TODO Changes by Purendra Comment this for (int i = 0; i <= lstTabUnderPolicyHolder.size();
      // i++) {
  ...
  public boolean verifyOutstandingWarningPopup(ExtentTest extentedReport) {
    ...
    if (WaitUtils.waitForElement(driver, btnWarningContinue, 2)
        && Utils.getTextOfWebElement(txtWarningMsg, driver).equalsIgnoreCase(
  ...
  /**
   * click Cancel button in STA popup
   * 
   * @param option
   * @param extentedReport
   * @throws Exception
   * 
   */
  public void clickCancelBtnInStaPopup(String option, ExtentTest extentedReport) throws Exception {
    try {
      switch (option) {

        case "cancel":
          WaitUtils.waitForElement(driver, btnStaCacnel);
          btnStaCacnel.click();
          Log.message("Clicked on the cancel button in STA pop up", extentedReport);
          break;

        case "close":
          WaitUtils.waitForElement(driver, btnStaClose);
          btnStaClose.click();
          Log.message("Clicked on the 'X' button(close) in STA pop up", extentedReport);
          break;
      }
      WaitUtils.waitForinvisiblityofElement(driver, 30, cssStaReason,
          "STA popup is not closed after 30sec");

    } catch (Exception e) {
      throw new Exception("Error while clicking " + option + " button in STA popup : " + e);
    }
  }

  /**
   * click Cancel button in MTA popup
   * 
   * @param option
   * @param extentedReport
   * @throws Exception
   * 
   */
  public void clickCancelBtnInMtaPopup(String option, ExtentTest extentedReport) throws Exception {
    try {
      switch (option) {

        case "cancel":
          WaitUtils.waitForElement(driver, btnMtaCacnel);
          btnMtaCacnel.click();
          Log.message("Clicked on the cancel button in MTA pop up", extentedReport);
          break;

        case "close":
          WaitUtils.waitForElement(driver, btnMtaClose);
          btnMtaClose.click();
          Log.message("Clicked on the 'X' button(close) in MTA pop up", extentedReport);
          break;
      }
      WaitUtils.waitForinvisiblityofElement(driver, 30, cssMtaReason,
          "STA popup is not closed after 30sec");

    } catch (Exception e) {
      throw new Exception("Error while clicking " + option + " button in MTA popup : " + e);
    }
  }

  /**
   *
   * To get Transaction Status Count
   * 
   * @param extentedReport
   * @param expectedStatus
   * @param expectedPosition
   ...
   * 
   */
  public String getTransactionStatusCount(ExtentTest extentedReport, String expectedPosition,
    ...
    try {
      ...
      return Integer.toString(rowSelected);

    } catch (Exception e) {
      throw new Exception("Error while getting status count from transaction table" + e);
    }
  ...
  /**
   *
   * To get Transaction Table Value
   * 
   * @param extentedReport
   * @param position
   * @throws Exception
   * 
   */
  public HashMap<String, String> getTransactionTableValue(String position,
      ExtentTest extentedReport) throws Exception {
    ...
    try {
      ...
      for (int loopcount = 0; loopcount < totalRowSize; loopcount++) {
        List<WebElement> lstTranscationRow =
            lstTransactionTable.get(loopcount).findElements(By.cssSelector(cssTransactionPosition));
        Integer TotalElement = lstTranscationRow.size();
        for (int elementCount = 0; elementCount < TotalElement; elementCount++) {

          if (lstTranscationRow.get(elementCount).getText().equals(position)) {

            String tax =
                lstTransactionTable.get(loopcount).findElement(By.cssSelector(cssTransactionTax))
                    .getText().replaceFirst("£", "").trim();
            String payable = lstTransactionTable.get(loopcount)
                .findElement(By.cssSelector(cssTransactionPayable)).getText().replaceFirst("£", "")
                .trim();
            String premium = lstTransactionTable.get(loopcount)
                .findElement(By.cssSelector(cssTransactionPremium)).getText().replaceFirst("£", "")
                .trim();

            Log.message("Transation Table Details:- Tax: [" + tax + "]; Payable: [" + payable
                + "]; Premium: [" + premium + "]", extentedReport);

            Details.put("Tax", tax);
            Details.put("Payable", payable);
            Details.put("Premium", premium);
            rowSelected = true;
          }
        }

        if (rowSelected) {
          Log.message(position + " - Transaction row is found", extentedReport);
          break;
        }
      }
      ...
      throw new Exception("Error while getting values from transaction table" + e);
    }
  ...
  /**
   *
   * verify Tax In TransactionTable
   * 
   * @param tax
   * @param premium
   * @throws Exception
   * 
   */
  public boolean verifyTaxInTransactionTable(String tax, String premium) throws Exception {

    try {
      boolean status = false;
      double premiumValue = Double.parseDouble(premium);
      double Tax = premiumValue * 0.12;

      String Value = String.format("%.2f", Tax);
      String[] number = Value.split("\\.");

      if (tax.startsWith(number[0])) {
        status = true;
      }
      ...
      throw new Exception("Error while verifying Tax In Transaction Table " + e);
    }
  ...
  /**
   *
   * verify payable In TransactionTable
   * 
   * @param tax
   * @param premium
   * @param payable
   ...
   * 
   */
  public boolean verifyPayableInTransactionTable(String tax, String premium, String payable)
      throws Exception {
    ...
    try {
      ...
      double paybaleValue = premiumValue + taxValue;

      String Value = String.format("%.2f", paybaleValue);
      String[] number = Value.split("\\.");
      if (payable.startsWith(number[0])) {
        status = true;
      }
      ...
      throw new Exception("Error while verifying payable In Transaction Table " + e);
    }
  ...
  /**
   *
   * verify Interested party on CustomerDashboard
   * 
   * @param tax
   * @param premium
   * @throws Exception
   * 
   */
  public boolean verifyInterestedpartiesOnCustomerDashboard(String Title, String FirstName,
      String LastName) throws Exception {

    try {
      boolean status = false;
      Utils.scrollIntoView(driver, InterestedPartycust);
      String interestedPartyName = Title + " " + FirstName + " " + LastName;
      System.out.println(interestedPartyName);
      System.out.println(InterestedPartycust.getText());
      if (interestedPartyName.equalsIgnoreCase(InterestedPartycust.getText())) {
        status = true;
      }
  ...
  public void TakePaymentInFinanceTabforMonths(int months, ExtentTest extentedReport)
      throws Exception {
    // TODO Auto-generated method stub
    try {
      for (int i = 0; i < months; i++) {
        WebElement monthsSelection = driver.findElement(
            By.cssSelector("input#C2__C6__FS_QUE_EB05634B0D109C89693217_0_R" + (i + 1)));
        // monthsSelection.click();
        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", monthsSelection);
      }
      Financetakepayment.click();
      WaitUtils.waitForSpinner(driver);
      enterTransactionIdInFinanceTab();

    } catch (Exception e) {
      throw new Exception("Error while making payment for " + months + "months" + e);
    }

  }

  private void enterTransactionIdInFinanceTab() {
    // TODO Auto-generated method stub
    TransactionIdInFinanceTab.clear();
    TransactionIdInFinanceTab.sendKeys(Utils.getRandomCharacters("NUMERIC", 3));
  }

  public String getTotalPaid(ExtentTest extentedReport2) {
    // TODO Auto-generated method stub

    String totalPaid = divTotalPaid.getText();
