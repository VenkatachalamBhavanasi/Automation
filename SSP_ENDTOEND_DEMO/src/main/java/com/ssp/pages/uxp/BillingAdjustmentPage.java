	...
	*/
	...
	public String enterChangePayorDetails(String lastName, String firstName, String postcode, ExtentTest extentedReport,
		...
		try {
			...
			WaitUtils.waitForinvisiblityofElement(driver, 10, cssConfirmbutton, "Change payor search window did not close after 3min");
		} catch (Exception e) {
			throw new Exception("Unable to click Change Payor button : " + e);
		}
		return payorName;
	...
	public boolean VerifyEngCenterTitle(String titleNameToVerify) throws Exception {
		try {
			...
			return Utils.verifyWebElementTextContains(txtEngCenter, titleNameToVerify);
	...
	public boolean VerifyCardDetailMsg(String msgToVerfiy) throws Exception {
		try {
			Utils.scrollIntoView(driver, msgCardDetail);	
			return Utils.verifyWebElementTextContains(msgCardDetail, msgToVerfiy);
	...
	public void changeAddressOne(String Address1, ExtentTest extentReport, boolean Screenshot) throws Exception {
		try {
			Utils.scrollIntoView(driver, txtAddress1);
			txtAddress1.clear();
	...
	public boolean verifyAmountToPay(String amount) throws Exception {
		try {
			return Utils.verifyWebElementTextContains(txtAmountToPay, amount);
	...
	public boolean verifyCardHolderName(String cardholderName) throws Exception {
		try {
			...
			return Utils.verifyWebElementTextContains(txtCardHoldName, cardholderName);
	...
	public void enterPaymentTrasaction(ExtentTest extentedReport) throws Exception {
		try {
			...
			WaitUtils.waitForelementToBeClickable(driver, txt_paymntRef, "Failed to get payment reference id after payment");
	 ...
	 * @throws Exception
	 */
	public void clickConfirmButton(ExtentTest extentedReport)
			throws Exception {
		try {
			(new WebDriverWait(driver, 10).pollingEvery(200, TimeUnit.MILLISECONDS)
						.ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
