...
public class BuyQuotePage extends LoadableComponent<BuyQuotePage> {
  ...
  @FindBy(css = "#C2__QUE_3661A386F2BF3E14953402")
  WebElement selectedpaymentplandrpdwn;
  ...
  @FindBy(css = "button[title='Buy'][value='Accept']")
  ...
  @FindBy(css = "input[id$='QUE_2411741C919DF0934660562']")
  WebElement txtTransactionIdOnRenewal;
  ...
  public void enterTrasactionIDForRenewal(ExtentTest extentedReport) throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, txtTransactionIdOnRenewal,
          "Failed to get transaction id field after payment");
      txtTransactionIdOnRenewal.sendKeys(Utils.getRandomCharacters("NUMERIC", 4));
      WaitUtils.waitForSpinner(driver);
      WaitUtils.waitForElementPresent(driver, txtTransactionIdOnRenewal, "");
      txtTransactionIdOnRenewal.sendKeys(Keys.TAB);
      lblPayment.click();
    ...
    try {
      ...
      switch (paymentplan) {
        case "Annual Payment Plan":
          ...
          ((JavascriptExecutor) driver).executeScript("arguments[0].click();", btnConfirmPayment);
          Thread.sleep(1000);
          WaitUtils.waitForSpinner(driver);
  ...
  public boolean verifyAcceptButton(ExtentTest extentedReport) throws Exception {
    try {
      WaitUtils.waitForSpinner(driver);
      (new WebDriverWait(driver, 20).pollingEvery(200, TimeUnit.MILLISECONDS)
          .ignoring(NoSuchElementException.class, StaleElementReferenceException.class)
          .withMessage("Unable to find Accept button"))
              .until(ExpectedConditions.visibilityOf(btnAcceptPayment));

      return btnAcceptPayment.isEnabled();
  ...
  public void clickChangePayorButton(ExtentTest extentedReport, boolean Screenshot)
      throws Exception {
    try {
      ((JavascriptExecutor) driver).executeScript("arguments[0].click();", btnChangePayor);
      Thread.sleep(1000);
  ...
  public String enterChangePayorDetails(String lastName, String firstName, String postcode,
    ...
    try {
      ...
      WaitUtils.waitForinvisiblityofElement(driver, 10, cssConfirmbutton,
  ...
  public boolean verifyDefaultTab(String tabName, ExtentTest extentedReport, boolean Screenshot)
      throws Exception {
    try {
      return Utils.verifyWebElementTextEquals(tab_SelectedTab, tabName);
  ...
  public boolean verifyPaymentPlan(String paymentPlan) {
    ...
    if (paymentPlandDropdown.getFirstSelectedOption().getText().equalsIgnoreCase(paymentPlan)) {
      status = true;
    }
    return status;
  }
   ...
   *        return boolean
   */
  public boolean verifyPaymentPlanRenewal(String paymentPlan) {
    boolean status = false;
    Select selectedpaymentplandrpdwnvalue = new Select(selectedpaymentplandrpdwn);

    if (selectedpaymentplandrpdwnvalue.getFirstSelectedOption().getText()
        .equalsIgnoreCase(paymentPlan)) {
      status = true;
    }
    return status;
  }
  ...
  public void clickAttachTermAndConditionButton(ExtentTest extentedReport) throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, btnAttachTermAndCondition,
          "Failed to locate Attach Termsandcondition button");
      ((JavascriptExecutor) driver).executeScript("arguments[0].click();",
          btnAttachTermAndCondition);
      WaitUtils.waitForSpinner(driver);
  ...
  public boolean verifyTandC_Edited(String policyToEdit, ExtentTest extentedReport,
    ...
    try {
      ...
      for (int i = 0; i < PolicyOptions.size(); i++) {
        ...
        String displayedPolicyName = driver
            .findElement(
      ...
      if (WaitUtils.waitForElement(driver, driver.findElement(By.cssSelector(cssEditButton)))) {
        driver.findElement(By.cssSelector(cssEditButton)).click();
      ...
      if (WaitUtils.waitForElement(driver, driver.findElement(By.cssSelector(cssTandCTextArea)))) {
        WaitUtils.waitForElement(driver, driver.findElement(By.cssSelector(cssSaveButton)));

        WebElement txtAreaTandC = // rowToClick
            driver.findElement(By.cssSelector(cssTandCTextArea));
        ((JavascriptExecutor) driver).executeScript("arguments[0].click()", txtAreaTandC);
        // Edit the text
        ((JavascriptExecutor) driver).executeScript("arguments[0].innerText ='Testing'",
            txtAreaTandC);
        WebElement btnSave = driver.findElement(By.cssSelector(cssSaveButton));
        btnSave.click();
        ...
        txtAreaTandC = driver.findElement(By.cssSelector(cssNewTxtArea));
  ...
  public void clickSavebuttonForRenewalQuoteinPPpage(String txtToenter, ExtentTest extentedReport)
    ...
    try {
      ...
      WaitUtils.waitForElement(driver, txtFld_quoteDescppPage);

      txtFld_quoteDescppPage.click();
      WaitUtils.waitForElementPresent(driver, txtFld_quoteDescppPage, "");
      // Thread.sleep(500);
      txtFld_quoteDescppPage.sendKeys(txtToenter);
      WaitUtils.waitForElementPresent(driver, txtFld_quoteDescppPage, "");
      // Thread.sleep(500);
      txtFld_quoteDescppPage.sendKeys(Keys.RETURN);
    ...
    try {
      ...
      switch (btntoClickinAcptancePage.toLowerCase()) {
        ...
        case "save":
          ...
          JavascriptExecutor executor = (JavascriptExecutor) driver;
          executor.executeScript("arguments[0].value='" + quoteDesc + "';",
              txtFldquoteDesc_acceptance);
          txtFldquoteDesc_acceptance.sendKeys(Keys.RETURN);

          Log.message("Entered Quote description:" + quoteDesc, driver, extentedReport, true);

          WaitUtils.waitForelementToBeClickable(driver, btnsaveQuoteDesc_acceptance,
              "Failed to locate quote variation save button on quote description modal");
        ...
        case "cancel":
          ...
          txtFldquoteDesc_acceptance.click();
          Thread.sleep(500);

          ((JavascriptExecutor) driver).executeScript("arguments[0].value='" + quoteDesc + "';",
              txtFldquoteDesc_acceptance);
          Thread.sleep(500);
          txtFldquoteDesc_acceptance.sendKeys(Keys.RETURN);
          ...
          btn_qutCancel.click();
          WaitUtils.waitForSpinner(driver);
          if (WaitUtils.waitForElement(driver, btnSaveinAcptancePage, 2)
  ...
  public void clickSaveDataCapture(ExtentTest extentReport, boolean Screenshot) throws Exception {
    try {
      WaitUtils.waitForElement(driver, btnSaveDatacapture, 20);
      // btnSaveDatacapture.click();
      ((JavascriptExecutor) driver).executeScript("arguments[0].click();", btnSaveDatacapture);
  ...
  public void clickCheckboxinPayment(ExtentTest extentedReport, boolean Screenshot)
    ...
    try {
      ...
      // if
      // (chkBx_toMakePayment.getAttribute("checked").equalsIgnoreCase("checked"))
      ...
      throw new Exception("Unable to click on payor checkbox, exception occured :" + e);
    }
  }
  ...
  public void addAccountDetail(HashMap<String, String> testdata, ExtentTest extentReport,
    ...
    try {
      ...
      String strAcctName = Utils.getRandomCharacters("ALPHA", 5);
  ...
  public boolean clicksavebuttoninAcceptancepage(String description, ExtentTest extentedReport)
    ...
    try {
      ...
      WaitUtils.waitForElementPresent(driver, btnSaveinAcptancePage,
          "Save button not present in acceptance page");
      // btnSaveinAcptancePage.click();
      ((JavascriptExecutor) driver).executeScript("arguments[0].click();", btnSaveinAcptancePage);
      // waitUtils.waitForSpinner(driver);
      Log.message("Clicked on Save button in accepatance page", extentedReport);
      Thread.sleep(1000);
      // Verify two radio button on save page
  ...
  public boolean verifyWarningMsg(ExtentTest extentedReport, String warningMsg) {
    ...
    Log.message("Warning pop up opened after clicking lapse button", extentedReport);
    // verify button and text
    if (Utils.verifyWebElementTextContains(msglapseWarningmsg, warningMsg)) {
      boolMsg = true;
    }
    return boolMsg;
  }
