...
public class SOAP_UI {
    ...
    */
    public void createPersonThroughSOAPCall(String projectFilePath, String testSuiteName, String testCaseName, String testStepName, String foreName, String surName) throws Exception, IOException, SoapUIException, XmlException, SAXException {
        ...
        testCase.setPropertyValue("customerFirstName", foreName);
        testCase.setPropertyValue("customerSurName", surName);
    ...
    public String createPersonThruSOAPCall(String projectFilePath, String testSuiteName, String testCaseName, String testStepName, String foreName, String surName, String email, String soapenv, ExtentTest extentedReport) throws Exception {
        String urn = null;
        WsdlProject wsdlProject = new WsdlProject(projectFilePath);
        ...
        testCase.setPropertyValue("customerFirstName", foreName);
        testCase.setPropertyValue("customerSurName", surName);
        testCase.setPropertyValue("emailAddress", email);
        TestStep testStep = testCase.getTestStepByName(testStepName);
        try {
            ...
            String response = runStepAndGetResponseContent(testRunner, testStep);
            Log.message("Create Person SoapUI response" +response, extentedReport);
            DocumentBuilder builder;
            ...
            urn = doc.getElementsByTagName("stn_1:objectIdentity").item(0).getTextContent();
    ...
    public String retrievePersonThroughSOAPCall(String projectFilePath, String testSuiteName, String testCaseName, String testStepName, String personkey, String soapenv,ExtentTest extentedReport) throws Exception, IOException, SoapUIException, XmlException, SAXException {
        ...
        testSuite.setPropertyValue("env", soapenv);
        TestCase testCase = testSuite.getTestCaseByName(testCaseName);
        testCase.setPropertyValue("personID", personkey);
        TestStep testStep = testCase.getTestStepByName(testStepName);
        try {
            WsdlTestCaseRunner testRunner = new com.eviware.soapui.impl.wsdl.testcase.WsdlTestCaseRunner((WsdlTestCase) testCase, new StringToObjectMap());
            String response = runStepAndGetResponseContent(testRunner, testStep);
    ...
    public String saveSystemUserThroughSOAPCall(String projectFilePath, String testSuiteName, String testCaseName, String testStepName, String personkey, String pricipalId, String soapenv,ExtentTest extentedReport) throws Exception, IOException, SoapUIException, XmlException, SAXException {
        ...
        TestCase testCase = testSuite.getTestCaseByName(testCaseName);
        testCase.setPropertyValue("personID", personkey);
        testCase.setPropertyValue("principalID", pricipalId);
        TestStep testStep = testCase.getTestStepByName(testStepName);
        try {
            WsdlTestCaseRunner testRunner = new com.eviware.soapui.impl.wsdl.testcase.WsdlTestCaseRunner((WsdlTestCase) testCase, new StringToObjectMap());
            String response = runStepAndGetResponseContent(testRunner, testStep);
            Log.message("Save System User SoapUI response" +response, extentedReport);
            DocumentBuilder builder;
            builder = DocumentBuilderFactory.newInstance().newDocumentBuilder();
            InputSource src = new InputSource();
            src.setCharacterStream(new StringReader(response));
            Document doc = builder.parse(src);
            roleType = doc.getElementsByTagName("stn_1:principalID").item(0).getTextContent();
            roleType = "Harshgevsprwrqy";
            personkey = null;
        } catch (ParserConfigurationException e) {
            Log.fail("System User role assignment failed", extentedReport);
        }
        wsdlProject.release();
        return roleType;

    }// saveSystemUserThroughSOAPCall
    
    
    public void saveUnderwriterThroughSOAPCall(String projectFilePath, String testSuiteName, String testCaseName, String testStepName, String personkey, String soapenv,ExtentTest extentedReport) throws Exception, IOException, SoapUIException, XmlException, SAXException {
        ...
        try {
            WsdlTestCaseRunner testRunner = new com.eviware.soapui.impl.wsdl.testcase.WsdlTestCaseRunner((WsdlTestCase) testCase, new StringToObjectMap());
            String response = runStepAndGetResponseContent(testRunner, testStep);
            Log.message("Underwriter Save SoapUI response" +response, extentedReport);
            DocumentBuilder builder;
            builder = DocumentBuilderFactory.newInstance().newDocumentBuilder();
            InputSource src = new InputSource();
            src.setCharacterStream(new StringReader(response));
            ...
            Log.fail("Underwriter role assignment failed", extentedReport);
        }
        wsdlProject.release();
      //  return roleType;

    }// saveUnderwriterThroughSOAPCalls
